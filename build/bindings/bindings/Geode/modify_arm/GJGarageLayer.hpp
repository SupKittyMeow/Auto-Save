...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJGarageLayer> : ModifyBase<ModifyDerive<Der, GJGarageLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2fb2e8, Default, GJGarageLayer, getItems, IconType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2fb710, Default, GJGarageLayer, onSelect, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2fc130, Default, GJGarageLayer, playRainbowEffect, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2fa4f4, Default, GJGarageLayer, selectTab, IconType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2fa624, Default, GJGarageLayer, setupPage, int, IconType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2fac80, Default, GJGarageLayer, setupSpecialPage, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2f8658, Default, GJGarageLayer, updatePlayerColors, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2f6b6c, Default, GJGarageLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2fd42c, Default, GJGarageLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2f9f8c, Default, GJGarageLayer, textInputOpened, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2fa0e4, Default, GJGarageLayer, textInputClosed, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2fa304, Default, GJGarageLayer, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2fc440, Default, GJGarageLayer, listButtonBarSwitchedPage, ListButtonBar*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2fc598, Default, GJGarageLayer, showUnlockPopup, int, UnlockType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2fd218, Default, GJGarageLayer, updateRate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2fcfe0, Default, GJGarageLayer, FLAlert_Clicked, FLAlertLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2fd0dc, Default, GJGarageLayer, dialogClosed, DialogLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2fc360, Default, GJGarageLayer, playerColorChanged, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2f9f7c, Default, GJGarageLayer, rewardedVideoFinished, )
		}
	};
}
