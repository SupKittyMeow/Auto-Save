...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, NumberInputLayer> : ModifyBase<ModifyDerive<Der, NumberInputLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x49bbe0, Default, NumberInputLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x49c650, Default, NumberInputLayer, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x49c5e0, Default, NumberInputLayer, keyBackClicked, )
		}
	};
}
