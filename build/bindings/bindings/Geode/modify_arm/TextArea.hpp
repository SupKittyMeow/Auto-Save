...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, TextArea> : ModifyBase<ModifyDerive<Der, TextArea>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2b0bf8, Default, TextArea, create, gd::string, char const*, float, float, cocos2d::CCPoint, float, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2b0f30, Default, TextArea, setString, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2b1950, Default, TextArea, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2b17a8, Default, TextArea, setOpacity, unsigned char)
		}
	};
}
