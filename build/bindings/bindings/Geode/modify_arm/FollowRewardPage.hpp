...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, FollowRewardPage> : ModifyBase<ModifyDerive<Der, FollowRewardPage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x39c0dc, Default, FollowRewardPage, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x39e0c0, Default, FollowRewardPage, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x39e044, Default, FollowRewardPage, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x39de2c, Default, FollowRewardPage, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x39dfb0, Default, FollowRewardPage, FLAlert_Clicked, FLAlertLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x39de1c, Default, FollowRewardPage, rewardedVideoFinished, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x39d754, Default, FollowRewardPage, updateRate, )
		}
	};
}
