...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCIMEDelegate> : ModifyBase<ModifyDerive<Der, cocos2d::CCIMEDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(base::get() + 0x4c5c10, Default, cocos2d::CCIMEDelegate)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4c5c40, Default, cocos2d::CCIMEDelegate, attachWithIME, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4c5e30, Default, cocos2d::CCIMEDelegate, detachWithIME, )
		}
	};
}
