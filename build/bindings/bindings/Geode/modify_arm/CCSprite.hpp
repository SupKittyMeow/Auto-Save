...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCSprite> : ModifyBase<ModifyDerive<Der, cocos2d::CCSprite>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22905c, Default, cocos2d::CCSprite, create, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22905c, Default, cocos2d::CCSprite, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x229240, Default, cocos2d::CCSprite, createWithSpriteFrame, cocos2d::CCSpriteFrame*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22932c, Default, cocos2d::CCSprite, createWithSpriteFrameName, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x228df0, Default, cocos2d::CCSprite, createWithTexture, cocos2d::CCTexture2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22ad7c, Default, cocos2d::CCSprite, setFlipX, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22adb0, Default, cocos2d::CCSprite, setFlipY, bool)
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(base::get() + 0x2297c4, Default, cocos2d::CCSprite, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(base::get() + 0x229898, Default, cocos2d::CCSprite)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x229434, Default, cocos2d::CCSprite, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22ac28, Default, cocos2d::CCSprite, setVertexZ, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22aaa4, Default, cocos2d::CCSprite, setScaleX, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22ab20, Default, cocos2d::CCSprite, setScaleY, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22ab9c, Default, cocos2d::CCSprite, setScale, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22a7e0, Default, cocos2d::CCSprite, setPosition, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22a9c4, Default, cocos2d::CCSprite, setSkewX, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22aa34, Default, cocos2d::CCSprite, setSkewY, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22ac98, Default, cocos2d::CCSprite, setAnchorPoint, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22ad0c, Default, cocos2d::CCSprite, setVisible, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22a874, Default, cocos2d::CCSprite, setRotation, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22a8e4, Default, cocos2d::CCSprite, setRotationX, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22a954, Default, cocos2d::CCSprite, setRotationY, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22ad08, Default, cocos2d::CCSprite, ignoreAnchorPointForPosition, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22a2fc, Default, cocos2d::CCSprite, addChild, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22a304, Default, cocos2d::CCSprite, addChild, cocos2d::CCNode*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22a304, Default, cocos2d::CCSprite, addChild, cocos2d::CCNode*, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22a46c, Default, cocos2d::CCSprite, removeChild, cocos2d::CCNode*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22a4b4, Default, cocos2d::CCSprite, removeAllChildrenWithCleanup, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22a3d8, Default, cocos2d::CCSprite, reorderChild, cocos2d::CCNode*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22a570, Default, cocos2d::CCSprite, sortAllChildren, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22a1e4, Default, cocos2d::CCSprite, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x229e30, Default, cocos2d::CCSprite, updateTransform, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2295b0, Default, cocos2d::CCSprite, initWithTexture, cocos2d::CCTexture2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2295a0, Default, cocos2d::CCSprite, initWithTexture, cocos2d::CCTexture2D*, cocos2d::CCRect const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22944c, Default, cocos2d::CCSprite, initWithTexture, cocos2d::CCTexture2D*, cocos2d::CCRect const&, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x229724, Default, cocos2d::CCSprite, initWithSpriteFrame, cocos2d::CCSpriteFrame*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x229788, Default, cocos2d::CCSprite, initWithSpriteFrameName, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22962c, Default, cocos2d::CCSprite, initWithFile, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2296c0, Default, cocos2d::CCSprite, initWithFile, char const*, cocos2d::CCRect const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22b110, Default, cocos2d::CCSprite, setChildColor, cocos2d::_ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22af9c, Default, cocos2d::CCSprite, setChildOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22b51c, Default, cocos2d::CCSprite, getBatchNode, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22b524, Default, cocos2d::CCSprite, setBatchNode, cocos2d::CCSpriteBatchNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x229934, Default, cocos2d::CCSprite, refreshTextureRect, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2299b8, Default, cocos2d::CCSprite, setTextureRect, cocos2d::CCRect const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2299cc, Default, cocos2d::CCSprite, setTextureRect, cocos2d::CCRect const&, bool, cocos2d::CCSize const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x229c60, Default, cocos2d::CCSprite, setVertexRect, cocos2d::CCRect const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22b29c, Default, cocos2d::CCSprite, setDisplayFrame, cocos2d::CCSpriteFrame*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22b370, Default, cocos2d::CCSprite, isFrameDisplayed, cocos2d::CCSpriteFrame*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22b414, Default, cocos2d::CCSprite, displayFrame, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22b31c, Default, cocos2d::CCSprite, setDisplayFrameWithAnimationName, char const*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x229c68, Default, cocos2d::CCSprite, setTextureCoords, cocos2d::CCRect const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22b570, Default, cocos2d::CCSprite, updateBlendFunc, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22a6f8, Default, cocos2d::CCSprite, setReorderChildDirtyRecursively, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22a760, Default, cocos2d::CCSprite, setDirtyRecursively, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22aea4, Default, cocos2d::CCSprite, setOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22b250, Default, cocos2d::CCSprite, updateDisplayedOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22b048, Default, cocos2d::CCSprite, setColor, cocos2d::_ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22b204, Default, cocos2d::CCSprite, updateDisplayedColor, cocos2d::_ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22b1bc, Default, cocos2d::CCSprite, setOpacityModifyRGB, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22b1f4, Default, cocos2d::CCSprite, isOpacityModifyRGB, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22b5c8, Default, cocos2d::CCSprite, setTexture, cocos2d::CCTexture2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22b708, Default, cocos2d::CCSprite, getTexture, )
		}
	};
}
