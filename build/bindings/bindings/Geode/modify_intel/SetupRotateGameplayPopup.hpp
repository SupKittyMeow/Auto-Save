...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupRotateGameplayPopup> : ModifyBase<ModifyDerive<Der, SetupRotateGameplayPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7a45a0, Default, SetupRotateGameplayPopup, onPlusButton, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7a45e0, Default, SetupRotateGameplayPopup, valueDidChange, int, float)
		}
	};
}
