...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCGLProgram> : ModifyBase<ModifyDerive<Der, cocos2d::CCGLProgram>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3a8704, Default, cocos2d::CCGLProgram, setUniformsForBuiltins, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3a89bc, Default, cocos2d::CCGLProgram, reset, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3a758c, Default, cocos2d::CCGLProgram, use, )
		}
	};
}
