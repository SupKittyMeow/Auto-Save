...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJChallengeItem> : ModifyBase<ModifyDerive<Der, GJChallengeItem>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7fb2c, Default, GJChallengeItem, encodeWithCoder, DS_Dictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7fc08, Default, GJChallengeItem, canEncode, )
		}
	};
}
