...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, AchievementNotifier> : ModifyBase<ModifyDerive<Der, AchievementNotifier>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6d44fc, Default, AchievementNotifier, sharedState, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6d4754, Default, AchievementNotifier, willSwitchToScene, cocos2d::CCScene*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6d4578, Default, AchievementNotifier, init, )
		}
	};
}
