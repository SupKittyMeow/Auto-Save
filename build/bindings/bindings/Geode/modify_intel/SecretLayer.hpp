...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SecretLayer> : ModifyBase<ModifyDerive<Der, SecretLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6056d0, Default, SecretLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6094b0, Default, SecretLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x608630, Default, SecretLayer, textInputOpened, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x608700, Default, SecretLayer, textInputClosed, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6087d0, Default, SecretLayer, textChanged, CCTextInputNode*)
		}
	};
}
