...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CollisionBlockPopup> : ModifyBase<ModifyDerive<Der, CollisionBlockPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x283350, Default, CollisionBlockPopup, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2832f0, Default, CollisionBlockPopup, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x283130, Default, CollisionBlockPopup, textInputClosed, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x283170, Default, CollisionBlockPopup, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x283380, Default, CollisionBlockPopup, textInputShouldOffset, CCTextInputNode*, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x283440, Default, CollisionBlockPopup, textInputReturn, CCTextInputNode*)
		}
	};
}
