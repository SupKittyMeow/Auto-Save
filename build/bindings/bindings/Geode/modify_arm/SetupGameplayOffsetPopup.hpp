...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupGameplayOffsetPopup> : ModifyBase<ModifyDerive<Der, SetupGameplayOffsetPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6ac8ac, Default, SetupGameplayOffsetPopup, updateInputValue, int, float&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6ac894, Default, SetupGameplayOffsetPopup, updateInputNode, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6ac844, Default, SetupGameplayOffsetPopup, triggerValueFromSliderValue, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6ac87c, Default, SetupGameplayOffsetPopup, triggerSliderValueFromValue, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6ac7b0, Default, SetupGameplayOffsetPopup, onCustomToggleTriggerValue, cocos2d::CCObject*)
		}
	};
}
