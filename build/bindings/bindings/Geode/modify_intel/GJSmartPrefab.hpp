...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJSmartPrefab> : ModifyBase<ModifyDerive<Der, GJSmartPrefab>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x432260, Default, GJSmartPrefab, encodeWithCoder, DS_Dictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x432110, Default, GJSmartPrefab, canEncode, )
		}
	};
}
