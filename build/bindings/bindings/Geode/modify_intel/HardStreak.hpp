...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, HardStreak> : ModifyBase<ModifyDerive<Der, HardStreak>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9d260, Default, HardStreak, addPoint, cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9d240, Default, HardStreak, reset, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9d200, Default, HardStreak, stopStroke, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9c970, Default, HardStreak, updateStroke, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9c7c0, Default, HardStreak, init, )
		}
	};
}
