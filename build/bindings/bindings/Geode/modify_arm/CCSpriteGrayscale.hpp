...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCSpriteGrayscale> : ModifyBase<ModifyDerive<Der, CCSpriteGrayscale>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x521c84, Default, CCSpriteGrayscale, create, gd::string const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x522ca0, Default, CCSpriteGrayscale, getShaderName, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x522b78, Default, CCSpriteGrayscale, shaderBody, )
		}
	};
}
