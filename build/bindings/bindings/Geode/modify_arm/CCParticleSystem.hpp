...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCParticleSystem> : ModifyBase<ModifyDerive<Der, cocos2d::CCParticleSystem>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6d8070, Default, cocos2d::CCParticleSystem, create, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6d9fbc, Default, cocos2d::CCParticleSystem, initParticle, cocos2d::sCCParticle*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6d83ec, Default, cocos2d::CCParticleSystem, initWithDictionary, cocos2d::CCDictionary*, char const*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6d9bf8, Default, cocos2d::CCParticleSystem, initWithDictionary, cocos2d::CCDictionary*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6d80f4, Default, cocos2d::CCParticleSystem, initWithFile, char const*, bool)
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(base::get() + 0x6d9dec, Default, cocos2d::CCParticleSystem)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6dac50, Default, cocos2d::CCParticleSystem, resetSystem, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6dac44, Default, cocos2d::CCParticleSystem, resumeSystem, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6dac30, Default, cocos2d::CCParticleSystem, stopSystem, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6dad94, Default, cocos2d::CCParticleSystem, update, float)
		}
	};
}
