...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupAdvFollowRetargetPopup> : ModifyBase<ModifyDerive<Der, SetupAdvFollowRetargetPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x30b0d0, Default, SetupAdvFollowRetargetPopup, updateDefaultTriggerValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x30b210, Default, SetupAdvFollowRetargetPopup, valueDidChange, int, float)
		}
	};
}
