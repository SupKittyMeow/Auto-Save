...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SimplePlayer> : ModifyBase<ModifyDerive<Der, SimplePlayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x36c360, Default, SimplePlayer, create, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x372200, Default, SimplePlayer, setSecondColor, cocos2d::_ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x36ffb0, Default, SimplePlayer, updateColors, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x36c630, Default, SimplePlayer, updatePlayerFrame, int, IconType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x372500, Default, SimplePlayer, setOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3721a0, Default, SimplePlayer, setColor, cocos2d::ccColor3B const&)
		}
	};
}
