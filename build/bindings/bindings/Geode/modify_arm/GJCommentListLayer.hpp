...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJCommentListLayer> : ModifyBase<ModifyDerive<Der, GJCommentListLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x23d01c, Default, GJCommentListLayer, create, BoomListView*, char const*, cocos2d::ccColor4B, float, float, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x23d114, Default, GJCommentListLayer, init, BoomListView*, char const*, cocos2d::ccColor4B, float, float, bool)
		}
	};
}
