...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCShaderCache> : ModifyBase<ModifyDerive<Der, cocos2d::CCShaderCache>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fc770, Default, cocos2d::CCShaderCache, sharedShaderCache, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fd650, Default, cocos2d::CCShaderCache, programForKey, char const*)
		}
	};
}
