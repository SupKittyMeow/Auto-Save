...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupCameraOffsetTrigger> : ModifyBase<ModifyDerive<Der, SetupCameraOffsetTrigger>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x58bb44, Default, SetupCameraOffsetTrigger, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x58c53c, Default, SetupCameraOffsetTrigger, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x58c2b4, Default, SetupCameraOffsetTrigger, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x58bf40, Default, SetupCameraOffsetTrigger, valuePopupClosed, ConfigureValuePopup*, float)
		}
	};
}
