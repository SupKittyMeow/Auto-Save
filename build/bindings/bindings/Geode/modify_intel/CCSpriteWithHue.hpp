...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCSpriteWithHue> : ModifyBase<ModifyDerive<Der, CCSpriteWithHue>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5fb200, Default, CCSpriteWithHue, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5faad0, Default, CCSpriteWithHue, initWithTexture, cocos2d::CCTexture2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5fab40, Default, CCSpriteWithHue, initWithTexture, cocos2d::CCTexture2D*, cocos2d::CCRect const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5fa890, Default, CCSpriteWithHue, initWithTexture, cocos2d::CCTexture2D*, cocos2d::CCRect const&, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5fab60, Default, CCSpriteWithHue, initWithSpriteFrame, cocos2d::CCSpriteFrame*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5fa3e0, Default, CCSpriteWithHue, getShaderName, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5faca0, Default, CCSpriteWithHue, shaderBody, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5facc0, Default, CCSpriteWithHue, updateColor, )
		}
	};
}
