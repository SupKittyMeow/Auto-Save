...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, EditTriggersPopup> : ModifyBase<ModifyDerive<Der, EditTriggersPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x296f20, Default, EditTriggersPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x296f30, Default, EditTriggersPopup, onClose, cocos2d::CCObject*)
		}
	};
}
