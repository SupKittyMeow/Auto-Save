...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCContentLayer> : ModifyBase<ModifyDerive<Der, CCContentLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(base::get() + 0x4bc530, Default, CCContentLayer)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7cf6c0, Default, CCContentLayer, setPosition, cocos2d::CCPoint const&)
		}
	};
}
