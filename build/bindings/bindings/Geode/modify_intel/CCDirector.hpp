...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCDirector> : ModifyBase<ModifyDerive<Der, cocos2d::CCDirector>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x48b350, Default, cocos2d::CCDirector, sharedDirector, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x48c750, Default, cocos2d::CCDirector, getWinSize, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x48cc80, Default, cocos2d::CCDirector, convertToGL, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x48bcd0, Default, cocos2d::CCDirector, drawScene, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x48d2f0, Default, cocos2d::CCDirector, popSceneWithTransition, float, cocos2d::PopTransition)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x48d060, Default, cocos2d::CCDirector, pushScene, cocos2d::CCScene*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x48d110, Default, cocos2d::CCDirector, replaceScene, cocos2d::CCScene*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x48cf70, Default, cocos2d::CCDirector, willSwitchToScene, cocos2d::CCScene*)
		}
	};
}
