...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCImage> : ModifyBase<ModifyDerive<Der, cocos2d::CCImage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x492d80, Default, cocos2d::CCImage, initWithImageData, void*, int, cocos2d::CCImage::EImageFormat, int, int, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x492b70, Default, cocos2d::CCImage, initWithImageFile, char const*, cocos2d::CCImage::EImageFormat)
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(base::get() + 0x492a70, Default, cocos2d::CCImage, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(base::get() + 0x492af0, Default, cocos2d::CCImage)
		}
	};
}
