...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, MenuGameLayer> : ModifyBase<ModifyDerive<Der, MenuGameLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x504f10, Default, MenuGameLayer, resetPlayer, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x504ab0, Default, MenuGameLayer, tryJump, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x504d10, Default, MenuGameLayer, updateColor, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x505750, Default, MenuGameLayer, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5045b0, Default, MenuGameLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x505cc0, Default, MenuGameLayer, ccTouchBegan, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x505e20, Default, MenuGameLayer, ccTouchCancelled, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x505e60, Default, MenuGameLayer, registerWithTouchDispatcher, )
		}
	};
}
