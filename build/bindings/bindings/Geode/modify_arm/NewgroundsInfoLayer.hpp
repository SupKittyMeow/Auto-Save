...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, NewgroundsInfoLayer> : ModifyBase<ModifyDerive<Der, NewgroundsInfoLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1c2fb8, Default, NewgroundsInfoLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1c3abc, Default, NewgroundsInfoLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1c3a64, Default, NewgroundsInfoLayer, FLAlert_Clicked, FLAlertLayer*, bool)
		}
	};
}
