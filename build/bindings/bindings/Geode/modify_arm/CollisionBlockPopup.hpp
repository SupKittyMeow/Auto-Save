...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CollisionBlockPopup> : ModifyBase<ModifyDerive<Der, CollisionBlockPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x227f98, Default, CollisionBlockPopup, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x227f4c, Default, CollisionBlockPopup, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x227de8, Default, CollisionBlockPopup, textInputClosed, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x227e04, Default, CollisionBlockPopup, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x227fa4, Default, CollisionBlockPopup, textInputShouldOffset, CCTextInputNode*, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x228074, Default, CollisionBlockPopup, textInputReturn, CCTextInputNode*)
		}
	};
}
