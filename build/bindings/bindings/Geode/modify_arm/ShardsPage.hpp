...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ShardsPage> : ModifyBase<ModifyDerive<Der, ShardsPage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x42df74, Default, ShardsPage, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x42fcc8, Default, ShardsPage, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x42fc4c, Default, ShardsPage, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x42fac4, Default, ShardsPage, show, )
		}
	};
}
