...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupPulsePopup> : ModifyBase<ModifyDerive<Der, SetupPulsePopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3b31d0, Default, SetupPulsePopup, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3b1e70, Default, SetupPulsePopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3b2a40, Default, SetupPulsePopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3b3250, Default, SetupPulsePopup, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3b2c20, Default, SetupPulsePopup, colorValueChanged, cocos2d::ccColor3B)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3b23b0, Default, SetupPulsePopup, colorSelectClosed, GJSpecialColorSelect*, int)
		}
	};
}
