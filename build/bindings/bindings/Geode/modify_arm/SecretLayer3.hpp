...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SecretLayer3> : ModifyBase<ModifyDerive<Der, SecretLayer3>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x41039c, Default, SecretLayer3, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x414e18, Default, SecretLayer3, onExit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x414e0c, Default, SecretLayer3, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x414ad4, Default, SecretLayer3, dialogClosed, DialogLayer*)
		}
	};
}
