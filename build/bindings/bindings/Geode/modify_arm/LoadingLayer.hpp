...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, LoadingLayer> : ModifyBase<ModifyDerive<Der, LoadingLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x32be04, Default, LoadingLayer, create, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x32bec4, Default, LoadingLayer, init, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x32c720, Default, LoadingLayer, loadAssets, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x32bd2c, Default, LoadingLayer, scene, bool)
		}
	};
}
