...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, EnhancedTriggerObject> : ModifyBase<ModifyDerive<Der, EnhancedTriggerObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x17587c, Default, EnhancedTriggerObject, customObjectSetup, gd::vector<gd::string>&, gd::vector<void*>&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x174f80, Default, EnhancedTriggerObject, getSaveString, GJBaseGameLayer*)
		}
	};
}
