...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCShaderCache> : ModifyBase<ModifyDerive<Der, cocos2d::CCShaderCache>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1aef0c, Default, cocos2d::CCShaderCache, sharedShaderCache, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1aff3c, Default, cocos2d::CCShaderCache, addProgram, cocos2d::CCGLProgram*, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1afe58, Default, cocos2d::CCShaderCache, programForKey, char const*)
		}
	};
}
