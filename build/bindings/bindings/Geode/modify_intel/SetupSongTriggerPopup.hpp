...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupSongTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupSongTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2d0dd0, Default, SetupSongTriggerPopup, pageChanged, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2d0e60, Default, SetupSongTriggerPopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2d0cd0, Default, SetupSongTriggerPopup, valueDidChange, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2d0a90, Default, SetupSongTriggerPopup, onPlayback, SongInfoObject*)
		}
	};
}
