...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupCameraEdgePopup> : ModifyBase<ModifyDerive<Der, SetupCameraEdgePopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x590a20, Default, SetupCameraEdgePopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x590cc0, Default, SetupCameraEdgePopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x590bb0, Default, SetupCameraEdgePopup, textChanged, CCTextInputNode*)
		}
	};
}
