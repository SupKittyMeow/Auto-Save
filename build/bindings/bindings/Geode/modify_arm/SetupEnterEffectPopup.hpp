...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupEnterEffectPopup> : ModifyBase<ModifyDerive<Der, SetupEnterEffectPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x375ab4, Default, SetupEnterEffectPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x375ea4, Default, SetupEnterEffectPopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x376020, Default, SetupEnterEffectPopup, updateInputValue, int, float&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x375fec, Default, SetupEnterEffectPopup, updateInputNode, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x375c24, Default, SetupEnterEffectPopup, valueDidChange, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x375f64, Default, SetupEnterEffectPopup, triggerValueFromSliderValue, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x375fb8, Default, SetupEnterEffectPopup, triggerSliderValueFromValue, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x375ce8, Default, SetupEnterEffectPopup, hsvPopupClosed, HSVWidgetPopup*, cocos2d::ccHSVValue)
		}
	};
}
