...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupRotatePopup> : ModifyBase<ModifyDerive<Der, SetupRotatePopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5a59e0, Default, SetupRotatePopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5a5a70, Default, SetupRotatePopup, onCustomToggleTriggerValue, cocos2d::CCObject*)
		}
	};
}
