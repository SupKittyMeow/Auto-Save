...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupPulsePopup> : ModifyBase<ModifyDerive<Der, SetupPulsePopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x337eec, Default, SetupPulsePopup, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x336e30, Default, SetupPulsePopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x337848, Default, SetupPulsePopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x337f48, Default, SetupPulsePopup, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3379d4, Default, SetupPulsePopup, colorValueChanged, cocos2d::ccColor3B)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3372e0, Default, SetupPulsePopup, colorSelectClosed, GJSpecialColorSelect*, int)
		}
	};
}
