...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, MusicSearchResult> : ModifyBase<ModifyDerive<Der, MusicSearchResult>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4e9b1c, Default, MusicSearchResult, updateObjects, AudioSortType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4e9aec, Default, MusicSearchResult, stateChanged, OptionsObject*)
		}
	};
}
