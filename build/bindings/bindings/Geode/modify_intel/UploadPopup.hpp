...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, UploadPopup> : ModifyBase<ModifyDerive<Der, UploadPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x27e660, Default, UploadPopup, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x27e200, Default, UploadPopup, levelUploadFinished, GJGameLevel*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x27e450, Default, UploadPopup, levelUploadFailed, GJGameLevel*)
		}
	};
}
