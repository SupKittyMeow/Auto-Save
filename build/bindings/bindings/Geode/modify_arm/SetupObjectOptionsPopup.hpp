...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupObjectOptionsPopup> : ModifyBase<ModifyDerive<Der, SetupObjectOptionsPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2aa6f8, Default, SetupObjectOptionsPopup, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2aa71c, Default, SetupObjectOptionsPopup, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2aa448, Default, SetupObjectOptionsPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2aa768, Default, SetupObjectOptionsPopup, onClose, cocos2d::CCObject*)
		}
	};
}
