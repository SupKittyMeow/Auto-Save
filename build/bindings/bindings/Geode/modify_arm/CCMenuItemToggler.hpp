...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCMenuItemToggler> : ModifyBase<ModifyDerive<Der, CCMenuItemToggler>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x50d28, Default, CCMenuItemToggler, create, cocos2d::CCNode*, cocos2d::CCNode*, cocos2d::CCObject*, cocos2d::SEL_MenuHandler)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x50e0c, Default, CCMenuItemToggler, init, cocos2d::CCNode*, cocos2d::CCNode*, cocos2d::CCObject*, cocos2d::SEL_MenuHandler)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x51318, Default, CCMenuItemToggler, setSizeMult, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x51240, Default, CCMenuItemToggler, toggle, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5146c, Default, CCMenuItemToggler, activate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5142c, Default, CCMenuItemToggler, selected, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x514ac, Default, CCMenuItemToggler, unselected, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x514ec, Default, CCMenuItemToggler, setEnabled, bool)
		}
	};
}
