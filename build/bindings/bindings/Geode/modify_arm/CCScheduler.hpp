...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCScheduler> : ModifyBase<ModifyDerive<Der, cocos2d::CCScheduler>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3bcbb4, Default, cocos2d::CCScheduler, scheduleSelector, cocos2d::SEL_SCHEDULE, cocos2d::CCObject*, float, unsigned int, float, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3bc6c0, Default, cocos2d::CCScheduler, unscheduleSelector, cocos2d::SEL_SCHEDULE, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3be890, Default, cocos2d::CCScheduler, update, float)
		}
	};
}
