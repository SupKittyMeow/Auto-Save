...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupCountTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupCountTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2b8570, Default, SetupCountTriggerPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2b8b00, Default, SetupCountTriggerPopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2b88a0, Default, SetupCountTriggerPopup, textChanged, CCTextInputNode*)
		}
	};
}
