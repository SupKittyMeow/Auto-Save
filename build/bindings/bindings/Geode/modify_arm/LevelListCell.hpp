...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, LevelListCell> : ModifyBase<ModifyDerive<Der, LevelListCell>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1eb538, Default, LevelListCell, loadFromList, GJLevelList*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fdf5c, Default, LevelListCell, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fe074, Default, LevelListCell, draw, )
		}
	};
}
