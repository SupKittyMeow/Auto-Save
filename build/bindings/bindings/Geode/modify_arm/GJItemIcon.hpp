...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJItemIcon> : ModifyBase<ModifyDerive<Der, GJItemIcon>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2fe438, Default, GJItemIcon, create, UnlockType, int, cocos2d::ccColor3B, cocos2d::ccColor3B, bool, bool, bool, cocos2d::ccColor3B)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2fea70, Default, GJItemIcon, setOpacity, unsigned char)
		}
	};
}
