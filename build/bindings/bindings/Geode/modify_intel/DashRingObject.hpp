...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, DashRingObject> : ModifyBase<ModifyDerive<Der, DashRingObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1b0340, Default, DashRingObject, customObjectSetup, gd::vector<gd::string>&, gd::vector<void*>&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1b04b0, Default, DashRingObject, getSaveString, GJBaseGameLayer*)
		}
	};
}
