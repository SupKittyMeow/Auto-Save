...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, UploadListPopup> : ModifyBase<ModifyDerive<Der, UploadListPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x365890, Default, UploadListPopup, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x365330, Default, UploadListPopup, listUploadFinished, GJLevelList*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x365550, Default, UploadListPopup, listUploadFailed, GJLevelList*, int)
		}
	};
}
