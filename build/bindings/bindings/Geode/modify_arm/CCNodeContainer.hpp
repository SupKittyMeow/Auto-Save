...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCNodeContainer> : ModifyBase<ModifyDerive<Der, CCNodeContainer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1293ec, Default, CCNodeContainer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1293f0, Default, CCNodeContainer, visit, )
		}
	};
}
