...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupCameraRotatePopup> : ModifyBase<ModifyDerive<Der, SetupCameraRotatePopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4c7d50, Default, SetupCameraRotatePopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4c8510, Default, SetupCameraRotatePopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4c82a0, Default, SetupCameraRotatePopup, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4c7fd0, Default, SetupCameraRotatePopup, valuePopupClosed, ConfigureValuePopup*, float)
		}
	};
}
