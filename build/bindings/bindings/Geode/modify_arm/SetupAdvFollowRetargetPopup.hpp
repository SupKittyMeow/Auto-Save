...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupAdvFollowRetargetPopup> : ModifyBase<ModifyDerive<Der, SetupAdvFollowRetargetPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x29d528, Default, SetupAdvFollowRetargetPopup, updateDefaultTriggerValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x29d6c8, Default, SetupAdvFollowRetargetPopup, valueDidChange, int, float)
		}
	};
}
