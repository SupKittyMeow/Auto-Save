...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, FMODAudioEngine> : ModifyBase<ModifyDerive<Der, FMODAudioEngine>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e0a80, Default, FMODAudioEngine, sharedEngine, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e4320, Default, FMODAudioEngine, channelForChannelID, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e1f70, Default, FMODAudioEngine, clearAllAudio, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3ef250, Default, FMODAudioEngine, fadeOutMusic, float, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e5fd0, Default, FMODAudioEngine, getActiveMusicChannel, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3eba70, Default, FMODAudioEngine, getEffectsVolume, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e7ec0, Default, FMODAudioEngine, getMeteringValue, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3ebaa0, Default, FMODAudioEngine, isMusicPlaying, gd::string, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e8a40, Default, FMODAudioEngine, playEffect, gd::string, float, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e8960, Default, FMODAudioEngine, playEffect, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e6190, Default, FMODAudioEngine, playEffectAdvanced, gd::string, float, float, float, float, bool, bool, int, int, int, int, bool, int, bool, bool, int, int, float, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e1f20, Default, FMODAudioEngine, resumeAllAudio, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3ebb30, Default, FMODAudioEngine, resumeAllMusic, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e0e30, Default, FMODAudioEngine, setup, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e2040, Default, FMODAudioEngine, stopAllEffects, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e2820, Default, FMODAudioEngine, stopAllMusic, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e2ac0, Default, FMODAudioEngine, update, float)
		}
	};
}
