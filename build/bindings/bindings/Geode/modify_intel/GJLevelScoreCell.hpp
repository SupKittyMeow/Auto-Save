...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJLevelScoreCell> : ModifyBase<ModifyDerive<Der, GJLevelScoreCell>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x251a10, Default, GJLevelScoreCell, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x251a60, Default, GJLevelScoreCell, draw, )
		}
	};
}
