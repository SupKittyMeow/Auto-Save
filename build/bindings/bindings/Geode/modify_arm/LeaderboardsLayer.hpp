...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, LeaderboardsLayer> : ModifyBase<ModifyDerive<Der, LeaderboardsLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46fc3c, Default, LeaderboardsLayer, create, LeaderboardState)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46fd08, Default, LeaderboardsLayer, init, LeaderboardState)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x471864, Default, LeaderboardsLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x47180c, Default, LeaderboardsLayer, FLAlert_Clicked, FLAlertLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x470e7c, Default, LeaderboardsLayer, updateUserScoreFinished, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x470eb4, Default, LeaderboardsLayer, updateUserScoreFailed, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x470f5c, Default, LeaderboardsLayer, loadLeaderboardFinished, cocos2d::CCArray*, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4715ac, Default, LeaderboardsLayer, loadLeaderboardFailed, char const*)
		}
	};
}
