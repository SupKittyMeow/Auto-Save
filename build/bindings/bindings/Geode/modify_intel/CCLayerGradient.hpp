...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCLayerGradient> : ModifyBase<ModifyDerive<Der, cocos2d::CCLayerGradient>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4bd4b0, Default, cocos2d::CCLayerGradient, create, cocos2d::_ccColor4B const&, cocos2d::_ccColor4B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4bd760, Default, cocos2d::CCLayerGradient, create, cocos2d::_ccColor4B const&, cocos2d::_ccColor4B const&, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4bd860, Default, cocos2d::CCLayerGradient, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4bd9a0, Default, cocos2d::CCLayerGradient, updateColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4bd890, Default, cocos2d::CCLayerGradient, initWithColor, cocos2d::_ccColor4B const&, cocos2d::_ccColor4B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4bd8f0, Default, cocos2d::CCLayerGradient, initWithColor, cocos2d::_ccColor4B const&, cocos2d::_ccColor4B const&, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4bdb90, Default, cocos2d::CCLayerGradient, getStartColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4bdba0, Default, cocos2d::CCLayerGradient, setStartColor, cocos2d::_ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4bdbf0, Default, cocos2d::CCLayerGradient, getEndColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4bdbc0, Default, cocos2d::CCLayerGradient, setEndColor, cocos2d::_ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4bdc20, Default, cocos2d::CCLayerGradient, getStartOpacity, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4bdc00, Default, cocos2d::CCLayerGradient, setStartOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4bdc50, Default, cocos2d::CCLayerGradient, getEndOpacity, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4bdc30, Default, cocos2d::CCLayerGradient, setEndOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4bdc90, Default, cocos2d::CCLayerGradient, getVector, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4bdc60, Default, cocos2d::CCLayerGradient, setVector, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4bdd30, Default, cocos2d::CCLayerGradient, setCompressedInterpolation, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4bdd20, Default, cocos2d::CCLayerGradient, isCompressedInterpolation, )
		}
	};
}
