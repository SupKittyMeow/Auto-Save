...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupItemCompareTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupItemCompareTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4d46b8, Default, SetupItemCompareTriggerPopup, valueDidChange, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4d4560, Default, SetupItemCompareTriggerPopup, onCustomToggleTriggerValue, cocos2d::CCObject*)
		}
	};
}
