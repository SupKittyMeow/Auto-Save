...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, AdvancedFollowEditObject> : ModifyBase<ModifyDerive<Der, AdvancedFollowEditObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x168dc8, Default, AdvancedFollowEditObject, customObjectSetup, gd::vector<gd::string>&, gd::vector<void*>&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x168150, Default, AdvancedFollowEditObject, getSaveString, GJBaseGameLayer*)
		}
	};
}
