...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCArray> : ModifyBase<ModifyDerive<Der, cocos2d::CCArray>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x63faac, Default, cocos2d::CCArray, createWithArray, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x63ff34, Default, cocos2d::CCArray, removeAllObjects, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x63ff18, Default, cocos2d::CCArray, removeObjectAtIndex, unsigned int, bool)
		}
	};
}
