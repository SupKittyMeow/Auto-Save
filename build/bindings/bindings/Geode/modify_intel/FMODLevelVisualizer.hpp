...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, FMODLevelVisualizer> : ModifyBase<ModifyDerive<Der, FMODLevelVisualizer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2ac1c0, Default, FMODLevelVisualizer, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2ac670, Default, FMODLevelVisualizer, updateVisualizer, float, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2ac230, Default, FMODLevelVisualizer, init, )
		}
	};
}
