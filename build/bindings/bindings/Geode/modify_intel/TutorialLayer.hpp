...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, TutorialLayer> : ModifyBase<ModifyDerive<Der, TutorialLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4e64f0, Default, TutorialLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4e6f30, Default, TutorialLayer, keyBackClicked, )
		}
	};
}
