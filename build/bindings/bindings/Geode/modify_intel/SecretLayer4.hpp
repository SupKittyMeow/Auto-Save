...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SecretLayer4> : ModifyBase<ModifyDerive<Der, SecretLayer4>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3b3ee0, Default, SecretLayer4, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3b84b0, Default, SecretLayer4, onExit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3b83c0, Default, SecretLayer4, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3b7500, Default, SecretLayer4, textInputOpened, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3b75d0, Default, SecretLayer4, textInputClosed, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3b76a0, Default, SecretLayer4, textChanged, CCTextInputNode*)
		}
	};
}
