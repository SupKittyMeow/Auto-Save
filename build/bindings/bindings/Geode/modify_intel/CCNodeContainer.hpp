...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCNodeContainer> : ModifyBase<ModifyDerive<Der, CCNodeContainer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x159cb0, Default, CCNodeContainer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x159cc0, Default, CCNodeContainer, visit, )
		}
	};
}
