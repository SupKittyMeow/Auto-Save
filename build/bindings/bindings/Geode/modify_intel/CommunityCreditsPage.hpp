...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CommunityCreditsPage> : ModifyBase<ModifyDerive<Der, CommunityCreditsPage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x31d3b0, Default, CommunityCreditsPage, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x31f930, Default, CommunityCreditsPage, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x31f8c0, Default, CommunityCreditsPage, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x31f730, Default, CommunityCreditsPage, show, )
		}
	};
}
