...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SelectEventLayer> : ModifyBase<ModifyDerive<Der, SelectEventLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x581790, Default, SelectEventLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5816c0, Default, SelectEventLayer, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x581490, Default, SelectEventLayer, onCustomToggleTriggerValue, cocos2d::CCObject*)
		}
	};
}
