...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GameManager> : ModifyBase<ModifyDerive<Der, GameManager>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(base::get() + 0x38ddc0, Default, GameManager)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3785a0, Default, GameManager, sharedState, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x382430, Default, GameManager, activeIconForType, IconType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x381490, Default, GameManager, colorForIdx, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3826a0, Default, GameManager, countForType, IconType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x38ccf0, Default, GameManager, didExitPlayscene, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x378e90, Default, GameManager, fadeInMenuMusic, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3853b0, Default, GameManager, getBGTexture, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x384950, Default, GameManager, getFontFile, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x378d40, Default, GameManager, getGameVariable, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x379930, Default, GameManager, iconTypeToUnlockType, IconType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x379ed0, Default, GameManager, isColorUnlocked, int, UnlockType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x379870, Default, GameManager, isIconUnlocked, int, IconType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x384b90, Default, GameManager, loadBackground, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x383830, Default, GameManager, loadIcon, int, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x38d750, Default, GameManager, reloadAll, bool, bool, bool, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x38d7f0, Default, GameManager, reloadAllStep2, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x38d9e0, Default, GameManager, reloadAllStep5, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x38d180, Default, GameManager, returnToLastScene, GJGameLevel*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x38d5b0, Default, GameManager, safePopScene, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3854a0, Default, GameManager, setGameVariable, char const*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x385a80, Default, GameManager, setIntGameVariable, char const*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x382cb0, Default, GameManager, sheetNameForIcon, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x38cd80, Default, GameManager, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x378600, Default, GameManager, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x38c1d0, Default, GameManager, encodeDataTo, DS_Dictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x38a360, Default, GameManager, dataLoaded, DS_Dictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x38b8c0, Default, GameManager, firstLoad, )
		}
	};
}
