...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, KeybindingsLayer> : ModifyBase<ModifyDerive<Der, KeybindingsLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x538ce8, Default, KeybindingsLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x53a5f0, Default, KeybindingsLayer, keyBackClicked, )
		}
	};
}
