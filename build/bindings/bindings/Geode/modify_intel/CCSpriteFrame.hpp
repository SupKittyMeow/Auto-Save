...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCSpriteFrame> : ModifyBase<ModifyDerive<Der, cocos2d::CCSpriteFrame>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x358210, Default, cocos2d::CCSpriteFrame, create, char const*, cocos2d::CCRect const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x358930, Default, cocos2d::CCSpriteFrame, create, char const*, cocos2d::CCRect const&, bool, cocos2d::CCPoint const&, cocos2d::CCSize const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x358410, Default, cocos2d::CCSpriteFrame, createWithTexture, cocos2d::CCTexture2D*, cocos2d::CCRect const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x358610, Default, cocos2d::CCSpriteFrame, createWithTexture, cocos2d::CCTexture2D*, cocos2d::CCRect const&, bool, cocos2d::CCPoint const&, cocos2d::CCSize const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x358520, Default, cocos2d::CCSpriteFrame, initWithTexture, cocos2d::CCTexture2D*, cocos2d::CCRect const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x358740, Default, cocos2d::CCSpriteFrame, initWithTexture, cocos2d::CCTexture2D*, cocos2d::CCRect const&, bool, cocos2d::CCPoint const&, cocos2d::CCSize const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x358320, Default, cocos2d::CCSpriteFrame, initWithTextureFilename, char const*, cocos2d::CCRect const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x358a60, Default, cocos2d::CCSpriteFrame, initWithTextureFilename, char const*, cocos2d::CCRect const&, bool, cocos2d::CCPoint const&, cocos2d::CCSize const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x359100, Default, cocos2d::CCSpriteFrame, getOffset, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3591a0, Default, cocos2d::CCSpriteFrame, getOffsetInPixels, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x359240, Default, cocos2d::CCSpriteFrame, getTexture, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x359110, Default, cocos2d::CCSpriteFrame, setOffset, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3591b0, Default, cocos2d::CCSpriteFrame, setOffsetInPixels, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x358f40, Default, cocos2d::CCSpriteFrame, setRect, cocos2d::CCRect const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x359020, Default, cocos2d::CCSpriteFrame, setRectInPixels, cocos2d::CCRect const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x358f00, Default, cocos2d::CCSpriteFrame, setTexture, cocos2d::CCTexture2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x358db0, Default, cocos2d::CCSpriteFrame, copyWithZone, cocos2d::CCZone*)
		}
	};
}
