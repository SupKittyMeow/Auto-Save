...
Adds a follower to the sprite
 ...
 @param follower Something that will follow this spr     * @note[short] Android
     */
...
Removes a specific following sprite from this sprite.
 ...
 @param sprite follower sprite that will be remov     * @note[short] Android
     */
...
Sets X's scale on itself and it's followers
 ...
 @param fScaleX the scale of X to      * @note[short] MacOS (ARM): 0x3f089c
...
Sets Y's scale on itself and it's followers
 ...
 @param fScaleY the scale of Y to      * @note[short] MacOS (ARM): 0x3f0918
...
Sets the Scale of itself and it's followers
 ...
 @param fScale the scale value to      * @note[short] MacOS (ARM): 0x3f0994
...
Sets the position where the sprite will be at and it's followers
 ...
 @param pos the position to place to the sprite and it's follow     * @note[short] MacOS (ARM): 0x3f056c
...
Sets the sprite's given rotation and it's followers
 ...
 @param fRotation the rotation value to      * @note[short] MacOS (ARM): 0x3f05e0
...
Sets the sprite's given rotation of X and it's followers
 ...
 @param fRotationX the rotation of X to s     * @note[short] MacOS (ARM): 0x3f0654
...
Sets the sprite's given rotation of Y and it's followers
 ...
 @param fRotationY the roation of Y to      * @note[short] MacOS (ARM): 0x3f06c8
...
Initalizes the sprite using a texture
 ...
 @return true if initalization succeed     * @note[short] MacOS (ARM): 0x3f0558
...
Initalizes the sprite with a frame name
 ...
 @return true if initalization succee     * @note[short] MacOS (ARM): 0x3f054c
