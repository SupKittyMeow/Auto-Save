...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, TutorialPopup> : ModifyBase<ModifyDerive<Der, TutorialPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5074ec, Default, TutorialPopup, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5075c0, Default, TutorialPopup, show, )
		}
	};
}
