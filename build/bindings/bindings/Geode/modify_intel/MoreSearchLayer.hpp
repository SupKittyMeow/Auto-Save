...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, MoreSearchLayer> : ModifyBase<ModifyDerive<Der, MoreSearchLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x638980, Default, MoreSearchLayer, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x639f30, Default, MoreSearchLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x63c100, Default, MoreSearchLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x63bf90, Default, MoreSearchLayer, textInputShouldOffset, CCTextInputNode*, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x63c050, Default, MoreSearchLayer, textInputReturn, CCTextInputNode*)
		}
	};
}
