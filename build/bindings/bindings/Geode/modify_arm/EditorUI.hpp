...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, EditorUI> : ModifyBase<ModifyDerive<Der, EditorUI>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2cf3c, Default, EditorUI, editGroup, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xb790, Default, EditorUI, init, LevelEditorLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xe734, Default, EditorUI, onPlayback, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xe948, Default, EditorUI, onPlaytest, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xeb88, Default, EditorUI, onStopPlaytest, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x322b8, Default, EditorUI, recreateButtonTabs, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x392e4, Default, EditorUI, showUI, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2dc08, Default, EditorUI, toggleLockUI, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2fc24, Default, EditorUI, updateObjectInfoLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x39504, Default, EditorUI, updateZoom, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xec6c, Default, EditorUI, zoomIn, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xecbc, Default, EditorUI, zoomOut, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x47170, Default, EditorUI, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x47b58, Default, EditorUI, ccTouchBegan, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x48138, Default, EditorUI, ccTouchMoved, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x48650, Default, EditorUI, ccTouchEnded, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x48e14, Default, EditorUI, ccTouchCancelled, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x48e30, Default, EditorUI, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3a68c, Default, EditorUI, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x48e68, Default, EditorUI, keyDown, cocos2d::enumKeyCodes)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4c3cc, Default, EditorUI, getUI, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x338c4, Default, EditorUI, setIDPopupClosed, SetIDPopup*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x336f4, Default, EditorUI, FLAlert_Clicked, FLAlertLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3bda4, Default, EditorUI, updateTransformControl, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3c65c, Default, EditorUI, transformChangeBegin, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4c3d0, Default, EditorUI, getTransformNode, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x45c34, Default, EditorUI, transformScaleXChanged, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x45dfc, Default, EditorUI, transformScaleYChanged, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x45f30, Default, EditorUI, transformScaleXYChanged, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46068, Default, EditorUI, transformSkewXChanged, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4619c, Default, EditorUI, transformSkewYChanged, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x462d0, Default, EditorUI, transformRotationXChanged, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46404, Default, EditorUI, transformRotationYChanged, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46538, Default, EditorUI, transformRotationChanged, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46670, Default, EditorUI, transformResetRotation, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46728, Default, EditorUI, transformRestoreRotation, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x39438, Default, EditorUI, songStateChanged, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x44150, Default, EditorUI, colorSelectClosed, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x49b30, Default, EditorUI, keyUp, cocos2d::enumKeyCodes)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x49ba8, Default, EditorUI, scrollWheel, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x47248, Default, EditorUI, angleChangeBegin, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4726c, Default, EditorUI, angleChanged, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3aa7c, Default, EditorUI, updateScaleControl, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3c710, Default, EditorUI, anchorPointMoved, cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3b070, Default, EditorUI, scaleChangeBegin, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3b094, Default, EditorUI, scaleXChanged, float, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3b6cc, Default, EditorUI, scaleYChanged, float, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3b810, Default, EditorUI, scaleXYChanged, float, float, bool)
		}
	};
}
