...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, DungeonBarsSprite> : ModifyBase<ModifyDerive<Der, DungeonBarsSprite>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x414e48, Default, DungeonBarsSprite, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x414ec8, Default, DungeonBarsSprite, visit, )
		}
	};
}
