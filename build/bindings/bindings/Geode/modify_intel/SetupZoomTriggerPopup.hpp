...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupZoomTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupZoomTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3200b0, Default, SetupZoomTriggerPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3200c0, Default, SetupZoomTriggerPopup, onClose, cocos2d::CCObject*)
		}
	};
}
