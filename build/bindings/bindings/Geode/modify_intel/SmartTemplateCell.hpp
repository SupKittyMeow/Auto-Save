...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SmartTemplateCell> : ModifyBase<ModifyDerive<Der, SmartTemplateCell>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x254b10, Default, SmartTemplateCell, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x254be0, Default, SmartTemplateCell, draw, )
		}
	};
}
