...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupEndPopup> : ModifyBase<ModifyDerive<Der, SetupEndPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x676a30, Default, SetupEndPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x676d50, Default, SetupEndPopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x676c00, Default, SetupEndPopup, textInputClosed, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x676c40, Default, SetupEndPopup, textChanged, CCTextInputNode*)
		}
	};
}
