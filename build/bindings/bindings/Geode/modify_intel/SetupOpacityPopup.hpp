...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupOpacityPopup> : ModifyBase<ModifyDerive<Der, SetupOpacityPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x591c0, Default, SetupOpacityPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x597c0, Default, SetupOpacityPopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x59520, Default, SetupOpacityPopup, textInputClosed, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x59560, Default, SetupOpacityPopup, textChanged, CCTextInputNode*)
		}
	};
}
