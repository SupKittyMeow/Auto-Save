...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJRequestCell> : ModifyBase<ModifyDerive<Der, GJRequestCell>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x253360, Default, GJRequestCell, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x253670, Default, GJRequestCell, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x253740, Default, GJRequestCell, FLAlert_Clicked, FLAlertLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x253910, Default, GJRequestCell, uploadActionFinished, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x253b10, Default, GJRequestCell, uploadActionFailed, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x253c20, Default, GJRequestCell, onClosePopup, UploadActionPopup*)
		}
	};
}
