...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ChallengesPage> : ModifyBase<ModifyDerive<Der, ChallengesPage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x327c74, Default, ChallengesPage, createChallengeNode, int, bool, float, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x326f90, Default, ChallengesPage, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3285b8, Default, ChallengesPage, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x32851c, Default, ChallengesPage, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x328390, Default, ChallengesPage, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x327ef8, Default, ChallengesPage, challengeStatusFinished, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3281b0, Default, ChallengesPage, challengeStatusFailed, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x328720, Default, ChallengesPage, currencyWillExit, CurrencyRewardLayer*)
		}
	};
}
