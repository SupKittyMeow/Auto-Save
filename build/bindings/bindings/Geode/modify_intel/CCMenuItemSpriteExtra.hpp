...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCMenuItemSpriteExtra> : ModifyBase<ModifyDerive<Der, CCMenuItemSpriteExtra>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x272d00, Default, CCMenuItemSpriteExtra, create, cocos2d::CCNode*, cocos2d::CCNode*, cocos2d::CCObject*, cocos2d::SEL_MenuHandler)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x272d90, Default, CCMenuItemSpriteExtra, init, cocos2d::CCNode*, cocos2d::CCNode*, cocos2d::CCObject*, cocos2d::SEL_MenuHandler)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x272f20, Default, CCMenuItemSpriteExtra, activate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x273090, Default, CCMenuItemSpriteExtra, selected, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x273300, Default, CCMenuItemSpriteExtra, unselected, )
		}
	};
}
