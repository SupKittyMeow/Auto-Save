...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, MultilineBitmapFont> : ModifyBase<ModifyDerive<Der, MultilineBitmapFont>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3f5744, Default, MultilineBitmapFont, createWithFont, char const*, gd::string, float, float, cocos2d::CCPoint, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3f73b4, Default, MultilineBitmapFont, setOpacity, unsigned char)
		}
	};
}
