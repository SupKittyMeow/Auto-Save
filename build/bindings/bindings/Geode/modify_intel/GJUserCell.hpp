...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJUserCell> : ModifyBase<ModifyDerive<Der, GJUserCell>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x251fd0, Default, GJUserCell, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2527a0, Default, GJUserCell, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x252870, Default, GJUserCell, FLAlert_Clicked, FLAlertLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x252b20, Default, GJUserCell, uploadActionFinished, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x252d10, Default, GJUserCell, uploadActionFailed, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x252e80, Default, GJUserCell, onClosePopup, UploadActionPopup*)
		}
	};
}
