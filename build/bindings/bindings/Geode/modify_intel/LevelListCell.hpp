...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, LevelListCell> : ModifyBase<ModifyDerive<Der, LevelListCell>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x240be0, Default, LevelListCell, loadFromList, GJLevelList*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2550a0, Default, LevelListCell, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2551e0, Default, LevelListCell, draw, )
		}
	};
}
