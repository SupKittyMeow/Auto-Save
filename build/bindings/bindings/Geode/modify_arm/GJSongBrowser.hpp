...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJSongBrowser> : ModifyBase<ModifyDerive<Der, GJSongBrowser>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x52f844, Default, GJSongBrowser, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x52faec, Default, GJSongBrowser, customSetup, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x52fabc, Default, GJSongBrowser, exitLayer, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x530014, Default, GJSongBrowser, FLAlert_Clicked, FLAlertLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5300d0, Default, GJSongBrowser, cellPerformedAction, TableViewCell*, int, CellAction, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x530130, Default, GJSongBrowser, getSelectedCellIdx, )
		}
	};
}
