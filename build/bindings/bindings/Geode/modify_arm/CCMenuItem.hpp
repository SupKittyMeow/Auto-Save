...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCMenuItem> : ModifyBase<ModifyDerive<Der, cocos2d::CCMenuItem>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(base::get() + 0x345478, Default, cocos2d::CCMenuItem)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3453ac, Default, cocos2d::CCMenuItem, initWithTarget, cocos2d::CCObject*, cocos2d::SEL_MenuHandler)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x345668, Default, cocos2d::CCMenuItem, setTarget, cocos2d::CCObject*, cocos2d::SEL_MenuHandler)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3455b8, Default, cocos2d::CCMenuItem, activate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x345534, Default, cocos2d::CCMenuItem, selected, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x345540, Default, cocos2d::CCMenuItem, unselected, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x345548, Default, cocos2d::CCMenuItem, registerScriptTapHandler, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x345578, Default, cocos2d::CCMenuItem, unregisterScriptTapHandler, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x34563c, Default, cocos2d::CCMenuItem, isEnabled, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x345634, Default, cocos2d::CCMenuItem, setEnabled, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x345660, Default, cocos2d::CCMenuItem, isSelected, )
		}
	};
}
