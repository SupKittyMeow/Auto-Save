...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SmartGameObject> : ModifyBase<ModifyDerive<Der, SmartGameObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1ac670, Default, SmartGameObject, customObjectSetup, gd::vector<gd::string>&, gd::vector<void*>&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1ac0c0, Default, SmartGameObject, getSaveString, GJBaseGameLayer*)
		}
	};
}
