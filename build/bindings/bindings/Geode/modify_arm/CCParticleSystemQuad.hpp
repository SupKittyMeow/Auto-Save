...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCParticleSystemQuad> : ModifyBase<ModifyDerive<Der, cocos2d::CCParticleSystemQuad>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x532fec, Default, cocos2d::CCParticleSystemQuad, create, char const*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x533d8c, Default, cocos2d::CCParticleSystemQuad, create, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(base::get() + 0x532f54, Default, cocos2d::CCParticleSystemQuad)
		}
	};
}
