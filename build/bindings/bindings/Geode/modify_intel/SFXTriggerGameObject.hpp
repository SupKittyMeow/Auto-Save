...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SFXTriggerGameObject> : ModifyBase<ModifyDerive<Der, SFXTriggerGameObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1c9be0, Default, SFXTriggerGameObject, customObjectSetup, gd::vector<gd::string>&, gd::vector<void*>&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1c4b10, Default, SFXTriggerGameObject, getSaveString, GJBaseGameLayer*)
		}
	};
}
