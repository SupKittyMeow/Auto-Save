...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTextureCache> : ModifyBase<ModifyDerive<Der, cocos2d::CCTextureCache>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5f61d0, Default, cocos2d::CCTextureCache, sharedTextureCache, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5f7450, Default, cocos2d::CCTextureCache, addImage, char const*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5f6650, Default, cocos2d::CCTextureCache, addImageAsync, char const*, cocos2d::CCObject*, cocos2d::SEL_MenuHandler, int, cocos2d::CCTexture2DPixelFormat)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5f8250, Default, cocos2d::CCTextureCache, addUIImage, cocos2d::CCImage*, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5f8850, Default, cocos2d::CCTextureCache, textureForKey, char const*)
		}
	};
}
