...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, TutorialLayer> : ModifyBase<ModifyDerive<Der, TutorialLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x441ce8, Default, TutorialLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x442764, Default, TutorialLayer, keyBackClicked, )
		}
	};
}
