...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CustomSongCell> : ModifyBase<ModifyDerive<Der, CustomSongCell>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x24f910, Default, CustomSongCell, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x24fb20, Default, CustomSongCell, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x24fa00, Default, CustomSongCell, songIDChanged, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x24fa80, Default, CustomSongCell, getActiveSongID, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x24fae0, Default, CustomSongCell, getSongFileName, )
		}
	};
}
