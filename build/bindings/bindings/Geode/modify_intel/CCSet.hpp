...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCSet> : ModifyBase<ModifyDerive<Der, cocos2d::CCSet>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7bfee0, Default, cocos2d::CCSet, anyObject, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7bfd00, Default, cocos2d::CCSet, count, )
		}
	};
}
