...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetFolderPopup> : ModifyBase<ModifyDerive<Der, SetFolderPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2a9a10, Default, SetFolderPopup, valueChanged, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2aa060, Default, SetFolderPopup, setTextPopupClosed, SetTextPopup*, gd::string)
		}
	};
}
