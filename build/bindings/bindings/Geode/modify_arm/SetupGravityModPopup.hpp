...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupGravityModPopup> : ModifyBase<ModifyDerive<Der, SetupGravityModPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x35def0, Default, SetupGravityModPopup, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x35dea4, Default, SetupGravityModPopup, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x35dda4, Default, SetupGravityModPopup, textInputClosed, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x35ddc0, Default, SetupGravityModPopup, textChanged, CCTextInputNode*)
		}
	};
}
