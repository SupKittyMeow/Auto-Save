...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, NumberInputLayer> : ModifyBase<ModifyDerive<Der, NumberInputLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4000ac, Default, NumberInputLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x400b3c, Default, NumberInputLayer, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x400ac0, Default, NumberInputLayer, keyBackClicked, )
		}
	};
}
