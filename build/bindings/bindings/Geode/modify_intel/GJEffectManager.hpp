...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJEffectManager> : ModifyBase<ModifyDerive<Der, GJEffectManager>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2da1c0, Default, GJEffectManager, activeColorForIndex, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2db560, Default, GJEffectManager, colorActionChanged, ColorAction*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2db530, Default, GJEffectManager, colorExists, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2e64b0, Default, GJEffectManager, isGroupEnabled, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2ea7b0, Default, GJEffectManager, loadFromState, EffectManagerState&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2dc570, Default, GJEffectManager, objectsCollided, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2da350, Default, GJEffectManager, shouldBlend, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2db6c0, Default, GJEffectManager, updateColorEffects, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2db590, Default, GJEffectManager, updateEffects, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2db890, Default, GJEffectManager, updatePulseEffects, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2d8d70, Default, GJEffectManager, init, )
		}
	};
}
