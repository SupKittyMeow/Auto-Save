...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTouchHandler> : ModifyBase<ModifyDerive<Der, cocos2d::CCTouchHandler>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x48a010, Default, cocos2d::CCTouchHandler, getDelegate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x48a090, Default, cocos2d::CCTouchHandler, getPriority, )
		}
	};
}
