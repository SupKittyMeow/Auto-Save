...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCScheduler> : ModifyBase<ModifyDerive<Der, cocos2d::CCScheduler>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x44cc60, Default, cocos2d::CCScheduler, pauseTarget, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x44b680, Default, cocos2d::CCScheduler, scheduleSelector, cocos2d::SEL_SCHEDULE, cocos2d::CCObject*, float, unsigned int, float, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x44b660, Default, cocos2d::CCScheduler, scheduleSelector, cocos2d::SEL_SCHEDULE, cocos2d::CCObject*, float, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x44c260, Default, cocos2d::CCScheduler, scheduleUpdateForTarget, cocos2d::CCObject*, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x44b190, Default, cocos2d::CCScheduler, unscheduleSelector, cocos2d::SEL_SCHEDULE, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x44d2a0, Default, cocos2d::CCScheduler, update, float)
		}
	};
}
