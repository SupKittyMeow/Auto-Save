...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, AudioAssetsBrowser> : ModifyBase<ModifyDerive<Der, AudioAssetsBrowser>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7c14e0, Default, AudioAssetsBrowser, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7c1470, Default, AudioAssetsBrowser, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7c1390, Default, AudioAssetsBrowser, musicActionFinished, GJMusicAction)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7c13c0, Default, AudioAssetsBrowser, musicActionFailed, GJMusicAction)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7c1400, Default, AudioAssetsBrowser, cellPerformedAction, TableViewCell*, int, CellAction, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7c1420, Default, AudioAssetsBrowser, getSelectedCellIdx, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7c1440, Default, AudioAssetsBrowser, getCellDelegateType, )
		}
	};
}
