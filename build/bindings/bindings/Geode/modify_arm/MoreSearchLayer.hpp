...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, MoreSearchLayer> : ModifyBase<ModifyDerive<Der, MoreSearchLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x559b2c, Default, MoreSearchLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x55bb44, Default, MoreSearchLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x55b9bc, Default, MoreSearchLayer, textInputShouldOffset, CCTextInputNode*, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x55ba8c, Default, MoreSearchLayer, textInputReturn, CCTextInputNode*)
		}
	};
}
