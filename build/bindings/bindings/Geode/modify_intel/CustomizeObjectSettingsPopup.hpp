...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CustomizeObjectSettingsPopup> : ModifyBase<ModifyDerive<Der, CustomizeObjectSettingsPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f3c00, Default, CustomizeObjectSettingsPopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f3b90, Default, CustomizeObjectSettingsPopup, onCustomToggleTriggerValue, cocos2d::CCObject*)
		}
	};
}
