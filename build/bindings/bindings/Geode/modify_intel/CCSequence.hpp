...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCSequence> : ModifyBase<ModifyDerive<Der, cocos2d::CCSequence>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3b8e10, Default, cocos2d::CCSequence, create, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3b8b50, Default, cocos2d::CCSequence, createWithVariableList, cocos2d::CCFiniteTimeAction*, va_list)
		}
	};
}
