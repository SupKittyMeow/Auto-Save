...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCAlertCircle> : ModifyBase<ModifyDerive<Der, CCAlertCircle>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1742b0, Default, CCAlertCircle, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x174340, Default, CCAlertCircle, draw, )
		}
	};
}
