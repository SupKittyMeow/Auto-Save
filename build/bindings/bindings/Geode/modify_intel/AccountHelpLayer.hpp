...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, AccountHelpLayer> : ModifyBase<ModifyDerive<Der, AccountHelpLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xd1910, Default, AccountHelpLayer, customSetup, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xd2740, Default, AccountHelpLayer, layerHidden, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xd2600, Default, AccountHelpLayer, accountStatusChanged, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xd2630, Default, AccountHelpLayer, FLAlert_Clicked, FLAlertLayer*, bool)
		}
	};
}
