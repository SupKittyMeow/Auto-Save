...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, NewgroundsInfoLayer> : ModifyBase<ModifyDerive<Der, NewgroundsInfoLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x211f60, Default, NewgroundsInfoLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x212a50, Default, NewgroundsInfoLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2129f0, Default, NewgroundsInfoLayer, FLAlert_Clicked, FLAlertLayer*, bool)
		}
	};
}
