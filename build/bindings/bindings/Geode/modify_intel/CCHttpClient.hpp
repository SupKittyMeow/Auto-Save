...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::extension::CCHttpClient> : ModifyBase<ModifyDerive<Der, cocos2d::extension::CCHttpClient>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x441e00, Default, cocos2d::extension::CCHttpClient, getInstance, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x441e60, Default, cocos2d::extension::CCHttpClient, destroyInstance, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x442d10, Default, cocos2d::extension::CCHttpClient, send, cocos2d::extension::CCHttpRequest*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x442160, Default, cocos2d::extension::CCHttpClient, lazyInitThreadSemphore, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x441ea0, Default, cocos2d::extension::CCHttpClient, dispatchResponseCallbacks, float)
		}
	};
}
