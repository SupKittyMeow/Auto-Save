...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupPickupTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupPickupTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5a2f0, Default, SetupPickupTriggerPopup, onPlusButton, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5a330, Default, SetupPickupTriggerPopup, onCustomToggleTriggerValue, cocos2d::CCObject*)
		}
	};
}
