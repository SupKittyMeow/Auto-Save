...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, UpdateAccountSettingsPopup> : ModifyBase<ModifyDerive<Der, UpdateAccountSettingsPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x240d24, Default, UpdateAccountSettingsPopup, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x240b20, Default, UpdateAccountSettingsPopup, updateSettingsFinished, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x240c38, Default, UpdateAccountSettingsPopup, updateSettingsFailed, )
		}
	};
}
