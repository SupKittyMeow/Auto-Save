...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetTextPopup> : ModifyBase<ModifyDerive<Der, SetTextPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x24af3c, Default, SetTextPopup, create, gd::string, gd::string, int, gd::string, gd::string, bool, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x24c27c, Default, SetTextPopup, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x24c230, Default, SetTextPopup, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x24c0f4, Default, SetTextPopup, textInputClosed, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x24c110, Default, SetTextPopup, textChanged, CCTextInputNode*)
		}
	};
}
