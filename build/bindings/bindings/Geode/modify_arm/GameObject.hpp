...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GameObject> : ModifyBase<ModifyDerive<Der, GameObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4edac4, Default, GameObject, addColorSprite, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f4054, Default, GameObject, addToCustomScaleX, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f407c, Default, GameObject, addToCustomScaleY, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4ed04c, Default, GameObject, commonSetup, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4ed1f8, Default, GameObject, createSpriteColor, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4ecf80, Default, GameObject, createWithFrame, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4ed010, Default, GameObject, init, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x50012c, Default, GameObject, isFacingDown, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5001d8, Default, GameObject, isFacingLeft, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f4c30, Default, GameObject, makeInvisible, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f775c, Default, GameObject, objectFromVector, gd::vector<gd::string>&, gd::vector<void*>&, GJBaseGameLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f4cac, Default, GameObject, playShineEffect, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x501178, Default, GameObject, setLastPosition, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4ef094, Default, GameObject, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f3d18, Default, GameObject, setScaleX, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f3db8, Default, GameObject, setScaleY, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f3e58, Default, GameObject, setScale, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f3740, Default, GameObject, setPosition, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f44a8, Default, GameObject, setVisible, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f39e0, Default, GameObject, setRotation, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f3ac8, Default, GameObject, setRotationX, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f3ba4, Default, GameObject, setRotationY, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f417c, Default, GameObject, setOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4ed1c4, Default, GameObject, initWithTexture, cocos2d::CCTexture2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4ff270, Default, GameObject, setChildColor, cocos2d::ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f3c70, Default, GameObject, setFlipX, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f3cc4, Default, GameObject, setFlipY, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x173c88, Default, GameObject, firstSetup, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4ef098, Default, GameObject, customSetup, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3bef18, Default, GameObject, setupCustomSprites, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f5a14, Default, GameObject, addMainSpriteToParent, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4ee694, Default, GameObject, resetObject, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x173904, Default, GameObject, triggerObject, GJBaseGameLayer*, int, gd::vector<int> const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4eeb4c, Default, GameObject, activateObject, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4eeed0, Default, GameObject, deactivateObject, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f3114, Default, GameObject, transferObjectRect, cocos2d::CCRect&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f31ec, Default, GameObject, getObjectRect, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f31a0, Default, GameObject, getObjectRect, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f3384, Default, GameObject, getObjectRect2, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f3448, Default, GameObject, getObjectTextureRect, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f36a0, Default, GameObject, getRealPosition, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4ee578, Default, GameObject, setStartPos, cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4ee9dc, Default, GameObject, updateStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x326d1c, Default, GameObject, customObjectSetup, gd::vector<gd::string>&, gd::vector<void*>&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f96a0, Default, GameObject, getSaveString, GJBaseGameLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f45f0, Default, GameObject, claimParticle, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f4b90, Default, GameObject, unclaimParticle, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f4bf8, Default, GameObject, particleWasActivated, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f3c60, Default, GameObject, isFlipX, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f3c68, Default, GameObject, isFlipY, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f3ef8, Default, GameObject, setRScaleX, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f3f2c, Default, GameObject, setRScaleY, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f3f60, Default, GameObject, setRScale, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f3fe4, Default, GameObject, getRScaleX, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f401c, Default, GameObject, getRScaleY, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f3948, Default, GameObject, setRRotation, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a135c, Default, GameObject, triggerActivated, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4fef58, Default, GameObject, setObjectColor, cocos2d::ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4ff218, Default, GameObject, setGlowColor, cocos2d::ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f4c18, Default, GameObject, restoreObject, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a1360, Default, GameObject, animationTriggered, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4ff2fc, Default, GameObject, selectObject, cocos2d::ccColor3B)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a1364, Default, GameObject, activatedByPlayer, PlayerObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a1368, Default, GameObject, hasBeenActivatedByPlayer, PlayerObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a1370, Default, GameObject, hasBeenActivated, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4ffd60, Default, GameObject, getOrientedBox, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4ffdf4, Default, GameObject, updateOrientedBox, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5058b0, Default, GameObject, getObjectRotation, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x500864, Default, GameObject, updateMainColor, cocos2d::ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x500d6c, Default, GameObject, updateSecondaryColor, cocos2d::ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f6170, Default, GameObject, addToGroup, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f624c, Default, GameObject, removeFromGroup, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4feda0, Default, GameObject, saveActiveColors, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a1378, Default, GameObject, spawnXPosition, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a1398, Default, GameObject, canAllowMultiActivate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a13a0, Default, GameObject, blendModeChanged, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4ff150, Default, GameObject, updateParticleColor, cocos2d::ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f4420, Default, GameObject, updateParticleOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a13a4, Default, GameObject, updateMainParticleOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a13a8, Default, GameObject, updateSecondaryParticleOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a13ac, Default, GameObject, canReverse, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a13b4, Default, GameObject, isSpecialSpawnObject, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a13bc, Default, GameObject, canBeOrdered, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a13c4, Default, GameObject, getObjectLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a13cc, Default, GameObject, setObjectLabel, cocos2d::CCLabelBMFont*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x501ae4, Default, GameObject, shouldDrawEditorHitbox, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a13d0, Default, GameObject, getHasSyncedAnimation, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a13d8, Default, GameObject, getHasRotateAction, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a13e0, Default, GameObject, canMultiActivate, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a13e8, Default, GameObject, updateTextKerning, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a13ec, Default, GameObject, getTextKerning, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a13f4, Default, GameObject, getObjectRectDirty, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a13fc, Default, GameObject, setObjectRectDirty, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a1404, Default, GameObject, getOrientedRectDirty, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a140c, Default, GameObject, setOrientedRectDirty, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a1414, Default, GameObject, getType, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a141c, Default, GameObject, setType, GameObjectType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a1424, Default, GameObject, getStartPos, cocos2d::CCPoint*)
		}
	};
}
