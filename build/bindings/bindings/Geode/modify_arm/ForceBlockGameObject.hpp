...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ForceBlockGameObject> : ModifyBase<ModifyDerive<Der, ForceBlockGameObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x19b710, Default, ForceBlockGameObject, customObjectSetup, gd::vector<gd::string>&, gd::vector<void*>&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x19aa80, Default, ForceBlockGameObject, getSaveString, GJBaseGameLayer*)
		}
	};
}
