...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJEffectManager> : ModifyBase<ModifyDerive<Der, GJEffectManager>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x276598, Default, GJEffectManager, activeColorForIndex, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2827a8, Default, GJEffectManager, loadFromState, EffectManagerState&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x275984, Default, GJEffectManager, init, )
		}
	};
}
