...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SpecialAnimGameObject> : ModifyBase<ModifyDerive<Der, SpecialAnimGameObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x16d79c, Default, SpecialAnimGameObject, resetObject, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x16d7a8, Default, SpecialAnimGameObject, customObjectSetup, gd::vector<gd::string>&, gd::vector<void*>&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x16d808, Default, SpecialAnimGameObject, getSaveString, GJBaseGameLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x16d77c, Default, SpecialAnimGameObject, updateMainColor, cocos2d::ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x16d78c, Default, SpecialAnimGameObject, updateSecondaryColor, cocos2d::ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2012e8, Default, SpecialAnimGameObject, updateSyncedAnimation, float, int)
		}
	};
}
