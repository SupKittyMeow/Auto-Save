...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupTouchTogglePopup> : ModifyBase<ModifyDerive<Der, SetupTouchTogglePopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2559d8, Default, SetupTouchTogglePopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x255cac, Default, SetupTouchTogglePopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x255ba4, Default, SetupTouchTogglePopup, textChanged, CCTextInputNode*)
		}
	};
}
