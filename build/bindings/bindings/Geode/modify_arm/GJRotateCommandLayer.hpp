...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJRotateCommandLayer> : ModifyBase<ModifyDerive<Der, GJRotateCommandLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7778, Default, GJRotateCommandLayer, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x8444, Default, GJRotateCommandLayer, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7fe8, Default, GJRotateCommandLayer, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7c2c, Default, GJRotateCommandLayer, valuePopupClosed, ConfigureValuePopup*, float)
		}
	};
}
