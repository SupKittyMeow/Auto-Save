...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, LeaderboardsLayer> : ModifyBase<ModifyDerive<Der, LeaderboardsLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x51a6d0, Default, LeaderboardsLayer, create, LeaderboardState)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x51a7d0, Default, LeaderboardsLayer, init, LeaderboardState)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x51c490, Default, LeaderboardsLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x51c430, Default, LeaderboardsLayer, FLAlert_Clicked, FLAlertLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x51ba00, Default, LeaderboardsLayer, updateUserScoreFinished, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x51ba60, Default, LeaderboardsLayer, updateUserScoreFailed, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x51bb00, Default, LeaderboardsLayer, loadLeaderboardFinished, cocos2d::CCArray*, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x51c1b0, Default, LeaderboardsLayer, loadLeaderboardFailed, char const*)
		}
	};
}
