...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCSpriteGrayscale> : ModifyBase<ModifyDerive<Der, CCSpriteGrayscale>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5fb5b0, Default, CCSpriteGrayscale, getShaderName, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5fb3b0, Default, CCSpriteGrayscale, shaderBody, )
		}
	};
}
