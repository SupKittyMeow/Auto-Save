...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCCountdown> : ModifyBase<ModifyDerive<Der, CCCountdown>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7d32c0, Default, CCCountdown, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7d3690, Default, CCCountdown, setOpacity, unsigned char)
		}
	};
}
