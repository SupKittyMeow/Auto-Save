...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, TopArtistsLayer> : ModifyBase<ModifyDerive<Der, TopArtistsLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x30fa80, Default, TopArtistsLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x310410, Default, TopArtistsLayer, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3103a0, Default, TopArtistsLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x310ee0, Default, TopArtistsLayer, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x310460, Default, TopArtistsLayer, loadListFinished, cocos2d::CCArray*, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x310520, Default, TopArtistsLayer, loadListFailed, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x310560, Default, TopArtistsLayer, setupPageInfo, gd::string, char const*)
		}
	};
}
