...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GravityEffectSprite> : ModifyBase<ModifyDerive<Der, GravityEffectSprite>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xbfda0, Default, GravityEffectSprite, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xc0000, Default, GravityEffectSprite, draw, )
		}
	};
}
