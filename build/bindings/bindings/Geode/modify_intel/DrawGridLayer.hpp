...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, DrawGridLayer> : ModifyBase<ModifyDerive<Der, DrawGridLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xf9a00, Default, DrawGridLayer, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xf9b90, Default, DrawGridLayer, draw, )
		}
	};
}
