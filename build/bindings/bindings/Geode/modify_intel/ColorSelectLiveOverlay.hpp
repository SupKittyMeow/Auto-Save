...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ColorSelectLiveOverlay> : ModifyBase<ModifyDerive<Der, ColorSelectLiveOverlay>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x571bd0, Default, ColorSelectLiveOverlay, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x571c80, Default, ColorSelectLiveOverlay, show, )
		}
	};
}
