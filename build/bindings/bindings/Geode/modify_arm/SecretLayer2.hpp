...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SecretLayer2> : ModifyBase<ModifyDerive<Der, SecretLayer2>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x40a32c, Default, SecretLayer2, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x410058, Default, SecretLayer2, onExit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x40ff6c, Default, SecretLayer2, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x40efbc, Default, SecretLayer2, textInputOpened, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x40f09c, Default, SecretLayer2, textInputClosed, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x40f1ac, Default, SecretLayer2, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x40d9f4, Default, SecretLayer2, dialogClosed, DialogLayer*)
		}
	};
}
