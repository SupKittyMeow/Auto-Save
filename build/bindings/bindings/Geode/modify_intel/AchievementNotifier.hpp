...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, AchievementNotifier> : ModifyBase<ModifyDerive<Der, AchievementNotifier>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7cf810, Default, AchievementNotifier, sharedState, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7cfa80, Default, AchievementNotifier, willSwitchToScene, cocos2d::CCScene*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7cf8a0, Default, AchievementNotifier, init, )
		}
	};
}
