...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, StartPosObject> : ModifyBase<ModifyDerive<Der, StartPosObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1b88a0, Default, StartPosObject, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1b89f0, Default, StartPosObject, customObjectSetup, gd::vector<gd::string>&, gd::vector<void*>&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1b8a00, Default, StartPosObject, getSaveString, GJBaseGameLayer*)
		}
	};
}
