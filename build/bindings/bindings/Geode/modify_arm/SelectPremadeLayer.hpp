...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SelectPremadeLayer> : ModifyBase<ModifyDerive<Der, SelectPremadeLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x29ba84, Default, SelectPremadeLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x29bfcc, Default, SelectPremadeLayer, keyBackClicked, )
		}
	};
}
