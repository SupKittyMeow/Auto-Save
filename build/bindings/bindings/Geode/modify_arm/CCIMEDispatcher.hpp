...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCIMEDispatcher> : ModifyBase<ModifyDerive<Der, cocos2d::CCIMEDispatcher>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x425760, Default, cocos2d::CCIMEDispatcher, dispatchDeleteBackward, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x425780, Default, cocos2d::CCIMEDispatcher, dispatchDeleteForward, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x425734, Default, cocos2d::CCIMEDispatcher, dispatchInsertText, char const*, int, cocos2d::enumKeyCodes)
		}
	};
}
