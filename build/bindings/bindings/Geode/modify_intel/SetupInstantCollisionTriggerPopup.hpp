...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupInstantCollisionTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupInstantCollisionTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x39aab0, Default, SetupInstantCollisionTriggerPopup, updateDefaultTriggerValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x39a7a0, Default, SetupInstantCollisionTriggerPopup, valueDidChange, int, float)
		}
	};
}
