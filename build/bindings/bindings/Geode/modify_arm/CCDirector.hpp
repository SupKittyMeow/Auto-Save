...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCDirector> : ModifyBase<ModifyDerive<Der, cocos2d::CCDirector>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3f0da8, Default, cocos2d::CCDirector, sharedDirector, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3f1edc, Default, cocos2d::CCDirector, getWinSize, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3f1560, Default, cocos2d::CCDirector, drawScene, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3f2950, Default, cocos2d::CCDirector, popSceneWithTransition, float, cocos2d::PopTransition)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3f269c, Default, cocos2d::CCDirector, pushScene, cocos2d::CCScene*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3f2764, Default, cocos2d::CCDirector, replaceScene, cocos2d::CCScene*)
		}
	};
}
