...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ColorSelectPopup> : ModifyBase<ModifyDerive<Der, ColorSelectPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x734fd0, Default, ColorSelectPopup, updateDurLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x738340, Default, ColorSelectPopup, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7360c0, Default, ColorSelectPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x738430, Default, ColorSelectPopup, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7368b0, Default, ColorSelectPopup, colorValueChanged, cocos2d::ccColor3B)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7389d0, Default, ColorSelectPopup, colorSelectClosed, GJSpecialColorSelect*, int)
		}
	};
}
