...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupObjectTogglePopup> : ModifyBase<ModifyDerive<Der, SetupObjectTogglePopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3782a0, Default, SetupObjectTogglePopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x378220, Default, SetupObjectTogglePopup, valueDidChange, int, float)
		}
	};
}
