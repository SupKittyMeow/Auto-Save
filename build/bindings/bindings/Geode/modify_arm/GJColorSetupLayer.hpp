...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJColorSetupLayer> : ModifyBase<ModifyDerive<Der, GJColorSetupLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1b7dc8, Default, GJColorSetupLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1b7dbc, Default, GJColorSetupLayer, colorSelectClosed, cocos2d::CCNode*)
		}
	};
}
