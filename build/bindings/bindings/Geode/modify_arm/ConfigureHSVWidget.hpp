...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ConfigureHSVWidget> : ModifyBase<ModifyDerive<Der, ConfigureHSVWidget>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3ad7c8, Default, ConfigureHSVWidget, textInputClosed, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3ad7e4, Default, ConfigureHSVWidget, textChanged, CCTextInputNode*)
		}
	};
}
