...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GameManager> : ModifyBase<ModifyDerive<Der, GameManager>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x303c64, Default, GameManager, sharedState, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x30c588, Default, GameManager, activeIconForType, IconType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x30b4e0, Default, GameManager, colorForIdx, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x30c648, Default, GameManager, countForType, IconType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x315cb0, Default, GameManager, didExitPlayscene, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3045f8, Default, GameManager, fadeInMenuMusic, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x30f070, Default, GameManager, getBGTexture, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x304480, Default, GameManager, getGameVariable, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x304f3c, Default, GameManager, iconTypeToUnlockType, IconType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x30533c, Default, GameManager, isColorUnlocked, int, UnlockType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x304e2c, Default, GameManager, isIconUnlocked, int, IconType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x30e7ec, Default, GameManager, loadBackground, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x30d514, Default, GameManager, loadIcon, int, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3166d4, Default, GameManager, reloadAll, bool, bool, bool, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x316774, Default, GameManager, reloadAllStep2, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x316948, Default, GameManager, reloadAllStep5, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x306c60, Default, GameManager, reportAchievementWithID, char const*, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x316184, Default, GameManager, returnToLastScene, GJGameLevel*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x31652c, Default, GameManager, safePopScene, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x30f154, Default, GameManager, setGameVariable, char const*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x30cad8, Default, GameManager, sheetNameForIcon, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x315d5c, Default, GameManager, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x303cd0, Default, GameManager, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3151c4, Default, GameManager, encodeDataTo, DS_Dictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3135bc, Default, GameManager, dataLoaded, DS_Dictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3149bc, Default, GameManager, firstLoad, )
		}
	};
}
