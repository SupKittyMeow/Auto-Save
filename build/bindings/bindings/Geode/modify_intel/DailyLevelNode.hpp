...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, DailyLevelNode> : ModifyBase<ModifyDerive<Der, DailyLevelNode>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22e0c0, Default, DailyLevelNode, init, GJGameLevel*, DailyLevelPage*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22edd0, Default, DailyLevelNode, FLAlert_Clicked, FLAlertLayer*, bool)
		}
	};
}
