...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupCameraEdgePopup> : ModifyBase<ModifyDerive<Der, SetupCameraEdgePopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4da060, Default, SetupCameraEdgePopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4da2b0, Default, SetupCameraEdgePopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4da1c4, Default, SetupCameraEdgePopup, textChanged, CCTextInputNode*)
		}
	};
}
