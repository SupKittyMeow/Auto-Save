...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCScene> : ModifyBase<ModifyDerive<Der, cocos2d::CCScene>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x28cbf0, Default, cocos2d::CCScene, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x28cca0, Default, cocos2d::CCScene, getHighestChildZ, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(base::get() + 0x28cb70, Default, cocos2d::CCScene)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x28cba0, Default, cocos2d::CCScene, init, )
		}
	};
}
