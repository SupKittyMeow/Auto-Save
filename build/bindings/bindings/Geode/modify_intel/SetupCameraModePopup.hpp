...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupCameraModePopup> : ModifyBase<ModifyDerive<Der, SetupCameraModePopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4b3bb0, Default, SetupCameraModePopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4b3ea0, Default, SetupCameraModePopup, onClose, cocos2d::CCObject*)
		}
	};
}
