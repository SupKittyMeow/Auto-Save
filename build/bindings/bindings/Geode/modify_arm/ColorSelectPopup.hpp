...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ColorSelectPopup> : ModifyBase<ModifyDerive<Der, ColorSelectPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x649d8c, Default, ColorSelectPopup, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x647c48, Default, ColorSelectPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x649e58, Default, ColorSelectPopup, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6482e8, Default, ColorSelectPopup, colorValueChanged, cocos2d::ccColor3B)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x64a358, Default, ColorSelectPopup, colorSelectClosed, GJSpecialColorSelect*, int)
		}
	};
}
