...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ParticlePreviewLayer> : ModifyBase<ModifyDerive<Der, ParticlePreviewLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e7efc, Default, ParticlePreviewLayer, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e7d74, Default, ParticlePreviewLayer, visit, )
		}
	};
}
