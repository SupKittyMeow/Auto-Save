...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupTeleportPopup> : ModifyBase<ModifyDerive<Der, SetupTeleportPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2e8840, Default, SetupTeleportPopup, updateDefaultTriggerValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2e895c, Default, SetupTeleportPopup, valueDidChange, int, float)
		}
	};
}
