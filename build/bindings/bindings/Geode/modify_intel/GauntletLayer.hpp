...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GauntletLayer> : ModifyBase<ModifyDerive<Der, GauntletLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3954e0, Default, GauntletLayer, create, GauntletType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3956d0, Default, GauntletLayer, init, GauntletType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3978b0, Default, GauntletLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x396e80, Default, GauntletLayer, loadLevelsFinished, cocos2d::CCArray*, char const*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x397010, Default, GauntletLayer, loadLevelsFailed, char const*, int)
		}
	};
}
