...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJScoreCell> : ModifyBase<ModifyDerive<Der, GJScoreCell>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1ef8c0, Default, GJScoreCell, loadFromScore, GJUserScore*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1faca0, Default, GJScoreCell, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1faf40, Default, GJScoreCell, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fae78, Default, GJScoreCell, FLAlert_Clicked, FLAlertLayer*, bool)
		}
	};
}
