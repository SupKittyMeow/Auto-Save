...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCAlertCircle> : ModifyBase<ModifyDerive<Der, CCAlertCircle>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13da28, Default, CCAlertCircle, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13dad4, Default, CCAlertCircle, draw, )
		}
	};
}
