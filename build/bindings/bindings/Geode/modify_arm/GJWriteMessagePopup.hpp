...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJWriteMessagePopup> : ModifyBase<ModifyDerive<Der, GJWriteMessagePopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x247474, Default, GJWriteMessagePopup, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x247460, Default, GJWriteMessagePopup, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2474ac, Default, GJWriteMessagePopup, textInputClosed, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2474d0, Default, GJWriteMessagePopup, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x247adc, Default, GJWriteMessagePopup, uploadMessageFinished, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x247bb4, Default, GJWriteMessagePopup, uploadMessageFailed, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x247cf4, Default, GJWriteMessagePopup, onClosePopup, UploadActionPopup*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x247e78, Default, GJWriteMessagePopup, FLAlert_Clicked, FLAlertLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x247f98, Default, GJWriteMessagePopup, textInputShouldOffset, CCTextInputNode*, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x248068, Default, GJWriteMessagePopup, textInputReturn, CCTextInputNode*)
		}
	};
}
