...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCFileUtils> : ModifyBase<ModifyDerive<Der, cocos2d::CCFileUtils>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4445e0, Default, cocos2d::CCFileUtils, fullPathForFilename, char const*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x443aa0, Default, cocos2d::CCFileUtils, getFileData, char const*, char const*, unsigned long*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x616a20, Default, cocos2d::CCFileUtils, sharedFileUtils, )
		}
	};
}
