...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupShaderEffectPopup> : ModifyBase<ModifyDerive<Der, SetupShaderEffectPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x26b028, Default, SetupShaderEffectPopup, toggleGroup, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x26a714, Default, SetupShaderEffectPopup, updateDefaultTriggerValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x26acfc, Default, SetupShaderEffectPopup, valueDidChange, int, float)
		}
	};
}
