...
private:
    [[deprecated("GJSmartTemplate::dataLoaded not implemented")]]
    /**
     * @note[short] Windows: 0x2a2f50
     * @note[short] Android
     */
...
private:
    [[deprecated("GJSmartTemplate::logTemplateStatus not implemented")]]
    /**
     * @note[short] Android
     */
...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x3a49f8
     * @note[short] MacOS (Intel): 0x431f60
     * @note[short] Windows: 0x2a3220
     * @note[short] Android
     */
    virtual void encodeWithCoder(DS_Dictionary* p0);

    /**
     * @note[short] MacOS (ARM): 0x3a4604
     * @note[short] MacOS (Intel): 0x431b50
     * @note[short] Android
     */
