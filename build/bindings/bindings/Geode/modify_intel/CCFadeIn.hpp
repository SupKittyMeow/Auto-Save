...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCFadeIn> : ModifyBase<ModifyDerive<Der, cocos2d::CCFadeIn>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3bde30, Default, cocos2d::CCFadeIn, create, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3bded0, Default, cocos2d::CCFadeIn, copyWithZone, cocos2d::CCZone*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3be270, Default, cocos2d::CCFadeIn, reverse, )
		}
	};
}
