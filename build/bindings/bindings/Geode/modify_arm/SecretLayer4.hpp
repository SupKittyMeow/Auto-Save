...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SecretLayer4> : ModifyBase<ModifyDerive<Der, SecretLayer4>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3388c4, Default, SecretLayer4, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x33cca8, Default, SecretLayer4, onExit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x33cbb4, Default, SecretLayer4, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x33bc9c, Default, SecretLayer4, textInputOpened, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x33bd7c, Default, SecretLayer4, textInputClosed, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x33be8c, Default, SecretLayer4, textChanged, CCTextInputNode*)
		}
	};
}
