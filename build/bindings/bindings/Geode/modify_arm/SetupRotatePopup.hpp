...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupRotatePopup> : ModifyBase<ModifyDerive<Der, SetupRotatePopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4ec7f4, Default, SetupRotatePopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4ec878, Default, SetupRotatePopup, onCustomToggleTriggerValue, cocos2d::CCObject*)
		}
	};
}
