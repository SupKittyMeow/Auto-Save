...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJMessageCell> : ModifyBase<ModifyDerive<Der, GJMessageCell>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x254100, Default, GJMessageCell, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x254410, Default, GJMessageCell, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2544e0, Default, GJMessageCell, FLAlert_Clicked, FLAlertLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x254670, Default, GJMessageCell, uploadActionFinished, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x254850, Default, GJMessageCell, uploadActionFailed, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2549c0, Default, GJMessageCell, onClosePopup, UploadActionPopup*)
		}
	};
}
