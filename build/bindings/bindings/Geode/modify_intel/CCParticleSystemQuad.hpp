...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCParticleSystemQuad> : ModifyBase<ModifyDerive<Der, cocos2d::CCParticleSystemQuad>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x60dce0, Default, cocos2d::CCParticleSystemQuad, create, char const*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x60f030, Default, cocos2d::CCParticleSystemQuad, create, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(base::get() + 0x60dc00, Default, cocos2d::CCParticleSystemQuad)
		}
	};
}
