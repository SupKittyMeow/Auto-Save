...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupAreaTintTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupAreaTintTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x43ec98, Default, SetupAreaTintTriggerPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x43ef98, Default, SetupAreaTintTriggerPopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x43eba8, Default, SetupAreaTintTriggerPopup, valueDidChange, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x43eddc, Default, SetupAreaTintTriggerPopup, hsvPopupClosed, HSVWidgetPopup*, cocos2d::ccHSVValue)
		}
	};
}
