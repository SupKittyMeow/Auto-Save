...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SongTriggerGameObject> : ModifyBase<ModifyDerive<Der, SongTriggerGameObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x185540, Default, SongTriggerGameObject, customObjectSetup, gd::vector<gd::string>&, gd::vector<void*>&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x184dc8, Default, SongTriggerGameObject, getSaveString, GJBaseGameLayer*)
		}
	};
}
