...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCObject> : ModifyBase<ModifyDerive<Der, cocos2d::CCObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(base::get() + 0x493bf0, Default, cocos2d::CCObject, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(base::get() + 0x493d00, Default, cocos2d::CCObject)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x493e30, Default, cocos2d::CCObject, autorelease, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x493e00, Default, cocos2d::CCObject, release, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x493e20, Default, cocos2d::CCObject, retain, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x493eb0, Default, cocos2d::CCObject, getTag, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x493e80, Default, cocos2d::CCObject, isEqual, cocos2d::CCObject const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x493e90, Default, cocos2d::CCObject, acceptVisitor, cocos2d::CCDataVisitor&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x493ed0, Default, cocos2d::CCObject, encodeWithCoder, DS_Dictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x493ef0, Default, cocos2d::CCObject, canEncode, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x493ec0, Default, cocos2d::CCObject, setTag, int)
		}
	};
}
