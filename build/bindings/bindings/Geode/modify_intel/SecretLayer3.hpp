...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SecretLayer3> : ModifyBase<ModifyDerive<Der, SecretLayer3>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4ad500, Default, SecretLayer3, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4b2400, Default, SecretLayer3, onExit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4b23d0, Default, SecretLayer3, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4b20b0, Default, SecretLayer3, dialogClosed, DialogLayer*)
		}
	};
}
