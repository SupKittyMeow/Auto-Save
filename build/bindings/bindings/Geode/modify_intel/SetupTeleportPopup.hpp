...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupTeleportPopup> : ModifyBase<ModifyDerive<Der, SetupTeleportPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x35ae30, Default, SetupTeleportPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x35ae40, Default, SetupTeleportPopup, updateDefaultTriggerValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x35af60, Default, SetupTeleportPopup, valueDidChange, int, float)
		}
	};
}
