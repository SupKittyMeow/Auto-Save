...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupStaticCameraPopup> : ModifyBase<ModifyDerive<Der, SetupStaticCameraPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x39ede0, Default, SetupStaticCameraPopup, valueDidChange, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x39ee70, Default, SetupStaticCameraPopup, onCustomToggleTriggerValue, cocos2d::CCObject*)
		}
	};
}
