...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJRewardObject> : ModifyBase<ModifyDerive<Der, GJRewardObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7ef00, Default, GJRewardObject, encodeWithCoder, DS_Dictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7ef80, Default, GJRewardObject, canEncode, )
		}
	};
}
