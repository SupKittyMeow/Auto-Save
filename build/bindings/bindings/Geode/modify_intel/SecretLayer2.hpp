...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SecretLayer2> : ModifyBase<ModifyDerive<Der, SecretLayer2>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4a6f10, Default, SecretLayer2, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4ad060, Default, SecretLayer2, onExit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4acf70, Default, SecretLayer2, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4abff0, Default, SecretLayer2, textInputOpened, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4ac0c0, Default, SecretLayer2, textInputClosed, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4ac190, Default, SecretLayer2, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4aaa60, Default, SecretLayer2, dialogClosed, DialogLayer*)
		}
	};
}
