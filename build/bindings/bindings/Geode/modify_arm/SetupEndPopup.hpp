...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupEndPopup> : ModifyBase<ModifyDerive<Der, SetupEndPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5914f4, Default, SetupEndPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x59177c, Default, SetupEndPopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x591674, Default, SetupEndPopup, textInputClosed, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x591690, Default, SetupEndPopup, textChanged, CCTextInputNode*)
		}
	};
}
