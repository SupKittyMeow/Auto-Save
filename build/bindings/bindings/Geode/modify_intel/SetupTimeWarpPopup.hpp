...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupTimeWarpPopup> : ModifyBase<ModifyDerive<Der, SetupTimeWarpPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x50dd50, Default, SetupTimeWarpPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x50dee0, Default, SetupTimeWarpPopup, onClose, cocos2d::CCObject*)
		}
	};
}
