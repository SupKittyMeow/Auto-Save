...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJSmartBlockPreviewSprite> : ModifyBase<ModifyDerive<Der, GJSmartBlockPreviewSprite>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x433380, Default, GJSmartBlockPreviewSprite, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x433390, Default, GJSmartBlockPreviewSprite, visit, )
		}
	};
}
