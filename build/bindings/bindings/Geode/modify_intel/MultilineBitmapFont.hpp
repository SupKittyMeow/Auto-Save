...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, MultilineBitmapFont> : ModifyBase<ModifyDerive<Der, MultilineBitmapFont>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x490240, Default, MultilineBitmapFont, createWithFont, char const*, gd::string, float, float, cocos2d::CCPoint, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4920d0, Default, MultilineBitmapFont, setOpacity, unsigned char)
		}
	};
}
