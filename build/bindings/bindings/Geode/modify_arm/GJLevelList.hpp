...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJLevelList> : ModifyBase<ModifyDerive<Der, GJLevelList>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x487c24, Default, GJLevelList, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4b8464, Default, GJLevelList, dataLoaded, DS_Dictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4b8794, Default, GJLevelList, encodeWithCoder, DS_Dictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4b89cc, Default, GJLevelList, canEncode, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4b6c9c, Default, GJLevelList, init, )
		}
	};
}
