...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, RewardsPage> : ModifyBase<ModifyDerive<Der, RewardsPage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x214cc0, Default, RewardsPage, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x216580, Default, RewardsPage, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x216510, Default, RewardsPage, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2163b0, Default, RewardsPage, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x216030, Default, RewardsPage, rewardsStatusFinished, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2162c0, Default, RewardsPage, rewardsStatusFailed, )
		}
	};
}
