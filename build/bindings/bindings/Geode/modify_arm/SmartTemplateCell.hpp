...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SmartTemplateCell> : ModifyBase<ModifyDerive<Der, SmartTemplateCell>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fdb3c, Default, SmartTemplateCell, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fdbf8, Default, SmartTemplateCell, draw, )
		}
	};
}
