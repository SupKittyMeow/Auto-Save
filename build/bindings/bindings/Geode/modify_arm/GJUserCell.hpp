...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJUserCell> : ModifyBase<ModifyDerive<Der, GJUserCell>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fb578, Default, GJUserCell, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fbd64, Default, GJUserCell, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fbe10, Default, GJUserCell, FLAlert_Clicked, FLAlertLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fc05c, Default, GJUserCell, uploadActionFinished, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fc264, Default, GJUserCell, uploadActionFailed, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fc3cc, Default, GJUserCell, onClosePopup, UploadActionPopup*)
		}
	};
}
