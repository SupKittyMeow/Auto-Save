...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCScene> : ModifyBase<ModifyDerive<Der, cocos2d::CCScene>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x230538, Default, cocos2d::CCScene, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x230610, Default, cocos2d::CCScene, getHighestChildZ, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(base::get() + 0x2149c0, Default, cocos2d::CCScene)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2304e0, Default, cocos2d::CCScene, init, )
		}
	};
}
