...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ExtendedLayer> : ModifyBase<ModifyDerive<Der, ExtendedLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3aa760, Default, ExtendedLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3aa770, Default, ExtendedLayer, setPosition, cocos2d::CCPoint const&)
		}
	};
}
