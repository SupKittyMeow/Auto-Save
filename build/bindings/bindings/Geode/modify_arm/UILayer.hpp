...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, UILayer> : ModifyBase<ModifyDerive<Der, UILayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x42fd64, Default, UILayer, create, GJBaseGameLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x430f10, Default, UILayer, disableMenu, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x431538, Default, UILayer, enableMenu, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x43103c, Default, UILayer, handleKeypress, cocos2d::enumKeyCodes, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x42fe64, Default, UILayer, init, GJBaseGameLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x431774, Default, UILayer, isJumpButtonPressed, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x431688, Default, UILayer, resetAllButtons, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x430d58, Default, UILayer, resetUINodeState, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x43154c, Default, UILayer, toggleMenuVisibility, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4317c0, Default, UILayer, ccTouchBegan, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x431a14, Default, UILayer, ccTouchMoved, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x431b48, Default, UILayer, ccTouchEnded, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x43245c, Default, UILayer, ccTouchCancelled, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x432478, Default, UILayer, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x431368, Default, UILayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x431328, Default, UILayer, keyDown, cocos2d::enumKeyCodes)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x431348, Default, UILayer, keyUp, cocos2d::enumKeyCodes)
		}
	};
}
