...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJPathSprite> : ModifyBase<ModifyDerive<Der, GJPathSprite>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2914a0, Default, GJPathSprite, create, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x295688, Default, GJPathSprite, addRankLabel, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x29512c, Default, GJPathSprite, addShardSprite, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2942e4, Default, GJPathSprite, changeToLockedArt, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x295578, Default, GJPathSprite, init, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x29154c, Default, GJPathSprite, updateState, )
		}
	};
}
