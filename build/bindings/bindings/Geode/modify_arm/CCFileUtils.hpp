...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCFileUtils> : ModifyBase<ModifyDerive<Der, cocos2d::CCFileUtils>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3b606c, Default, cocos2d::CCFileUtils, fullPathForFilename, char const*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3b5588, Default, cocos2d::CCFileUtils, getFileData, char const*, char const*, unsigned long*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x53a6d0, Default, cocos2d::CCFileUtils, sharedFileUtils, )
		}
	};
}
