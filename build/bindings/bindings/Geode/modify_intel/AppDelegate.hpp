...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, AppDelegate> : ModifyBase<ModifyDerive<Der, AppDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x669430, Default, AppDelegate, get, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6692b0, Default, AppDelegate, applicationDidFinishLaunching, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x669550, Default, AppDelegate, applicationDidEnterBackground, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x669690, Default, AppDelegate, applicationWillEnterForeground, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x669450, Default, AppDelegate, applicationWillBecomeActive, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x669470, Default, AppDelegate, applicationWillResignActive, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x669920, Default, AppDelegate, trySaveGame, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x669a00, Default, AppDelegate, willSwitchToScene, cocos2d::CCScene*)
		}
	};
}
