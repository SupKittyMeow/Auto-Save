...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCCircleWave> : ModifyBase<ModifyDerive<Der, CCCircleWave>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x173740, Default, CCCircleWave, create, float, float, float, bool, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x173730, Default, CCCircleWave, create, float, float, float, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x173af0, Default, CCCircleWave, followObject, cocos2d::CCNode*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x173820, Default, CCCircleWave, init, float, float, float, bool, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x173ab0, Default, CCCircleWave, updatePosition, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x173a80, Default, CCCircleWave, setPosition, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x173f10, Default, CCCircleWave, removeMeAndCleanup, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x173dd0, Default, CCCircleWave, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x173b80, Default, CCCircleWave, updateTweenAction, float, char const*)
		}
	};
}
