...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTextureCache> : ModifyBase<ModifyDerive<Der, cocos2d::CCTextureCache>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x51e0e4, Default, cocos2d::CCTextureCache, sharedTextureCache, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x51f2d0, Default, cocos2d::CCTextureCache, addImage, char const*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x51e554, Default, cocos2d::CCTextureCache, addImageAsync, char const*, cocos2d::CCObject*, cocos2d::SEL_MenuHandler, int, cocos2d::CCTexture2DPixelFormat)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x520194, Default, cocos2d::CCTextureCache, addUIImage, cocos2d::CCImage*, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5207c8, Default, cocos2d::CCTextureCache, textureForKey, char const*)
		}
	};
}
