...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SongTriggerGameObject> : ModifyBase<ModifyDerive<Der, SongTriggerGameObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1cb1c0, Default, SongTriggerGameObject, customObjectSetup, gd::vector<gd::string>&, gd::vector<void*>&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1ca8d0, Default, SongTriggerGameObject, getSaveString, GJBaseGameLayer*)
		}
	};
}
