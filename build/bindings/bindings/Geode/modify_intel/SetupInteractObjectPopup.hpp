...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupInteractObjectPopup> : ModifyBase<ModifyDerive<Der, SetupInteractObjectPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x516e30, Default, SetupInteractObjectPopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x516d40, Default, SetupInteractObjectPopup, onPlusButton, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x516d80, Default, SetupInteractObjectPopup, valueDidChange, int, float)
		}
	};
}
