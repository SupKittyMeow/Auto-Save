...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, PlayerFireBoostSprite> : ModifyBase<ModifyDerive<Der, PlayerFireBoostSprite>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x396058, Default, PlayerFireBoostSprite, animateFireIn, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3960d8, Default, PlayerFireBoostSprite, animateFireOut, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x395d88, Default, PlayerFireBoostSprite, loopFireAnimation, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x39aa50, Default, PlayerFireBoostSprite, init, )
		}
	};
}
