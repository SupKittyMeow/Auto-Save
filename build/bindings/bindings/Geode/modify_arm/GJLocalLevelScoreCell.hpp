...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJLocalLevelScoreCell> : ModifyBase<ModifyDerive<Der, GJLocalLevelScoreCell>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fb06c, Default, GJLocalLevelScoreCell, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fb078, Default, GJLocalLevelScoreCell, draw, )
		}
	};
}
