...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, HSVLiveOverlay> : ModifyBase<ModifyDerive<Der, HSVLiveOverlay>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x267120, Default, HSVLiveOverlay, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2671d0, Default, HSVLiveOverlay, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2672a0, Default, HSVLiveOverlay, hsvChanged, ConfigureHSVWidget*)
		}
	};
}
