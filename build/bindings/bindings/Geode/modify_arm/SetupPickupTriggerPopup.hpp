...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupPickupTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupPickupTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x50a20, Default, SetupPickupTriggerPopup, onPlusButton, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x50a58, Default, SetupPickupTriggerPopup, onCustomToggleTriggerValue, cocos2d::CCObject*)
		}
	};
}
