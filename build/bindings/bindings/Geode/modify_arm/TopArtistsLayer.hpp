...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, TopArtistsLayer> : ModifyBase<ModifyDerive<Der, TopArtistsLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2a16c0, Default, TopArtistsLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2a1fe0, Default, TopArtistsLayer, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2a1f64, Default, TopArtistsLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2a2a5c, Default, TopArtistsLayer, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2a2020, Default, TopArtistsLayer, loadListFinished, cocos2d::CCArray*, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2a20e4, Default, TopArtistsLayer, loadListFailed, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2a210c, Default, TopArtistsLayer, setupPageInfo, gd::string, char const*)
		}
	};
}
