...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SecretLayer> : ModifyBase<ModifyDerive<Der, SecretLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x52bc04, Default, SecretLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x52f41c, Default, SecretLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x52e828, Default, SecretLayer, textInputOpened, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x52e908, Default, SecretLayer, textInputClosed, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x52ea18, Default, SecretLayer, textChanged, CCTextInputNode*)
		}
	};
}
