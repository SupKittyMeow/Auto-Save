...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, WorldLevelPage> : ModifyBase<ModifyDerive<Der, WorldLevelPage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3ca580, Default, WorldLevelPage, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3ca440, Default, WorldLevelPage, show, )
		}
	};
}
