...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ShareCommentLayer> : ModifyBase<ModifyDerive<Der, ShareCommentLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x513870, Default, ShareCommentLayer, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5137c8, Default, ShareCommentLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5138a8, Default, ShareCommentLayer, textInputClosed, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x513a2c, Default, ShareCommentLayer, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x513cac, Default, ShareCommentLayer, uploadActionFinished, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x513de4, Default, ShareCommentLayer, uploadActionFailed, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x513f44, Default, ShareCommentLayer, onClosePopup, UploadActionPopup*)
		}
	};
}
