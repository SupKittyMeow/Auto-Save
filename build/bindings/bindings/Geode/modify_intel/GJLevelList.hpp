...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJLevelList> : ModifyBase<ModifyDerive<Der, GJLevelList>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x56afa0, Default, GJLevelList, encodeWithCoder, DS_Dictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x56b210, Default, GJLevelList, canEncode, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x569080, Default, GJLevelList, init, )
		}
	};
}
