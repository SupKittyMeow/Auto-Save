...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CustomSFXCell> : ModifyBase<ModifyDerive<Der, CustomSFXCell>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f9ad0, Default, CustomSFXCell, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f9b74, Default, CustomSFXCell, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f9ae0, Default, CustomSFXCell, sfxObjectSelected, SFXInfoObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f9b3c, Default, CustomSFXCell, getActiveSFXID, )
		}
	};
}
