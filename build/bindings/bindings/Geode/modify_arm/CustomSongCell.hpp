...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CustomSongCell> : ModifyBase<ModifyDerive<Der, CustomSongCell>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f9818, Default, CustomSongCell, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f9998, Default, CustomSongCell, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f98dc, Default, CustomSongCell, songIDChanged, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f9938, Default, CustomSongCell, getActiveSongID, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f9970, Default, CustomSongCell, getSongFileName, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f9988, Default, CustomSongCell, getLevelSettings, )
		}
	};
}
