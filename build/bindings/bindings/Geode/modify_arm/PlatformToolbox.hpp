...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, PlatformToolbox> : ModifyBase<ModifyDerive<Der, PlatformToolbox>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x42c87c, Default, PlatformToolbox, hideCursor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x42d470, Default, PlatformToolbox, isControllerConnected, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x42c894, Default, PlatformToolbox, showCursor, )
		}
	};
}
