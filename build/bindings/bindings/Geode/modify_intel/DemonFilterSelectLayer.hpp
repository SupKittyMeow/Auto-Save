...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, DemonFilterSelectLayer> : ModifyBase<ModifyDerive<Der, DemonFilterSelectLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x63c460, Default, DemonFilterSelectLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x63ca50, Default, DemonFilterSelectLayer, keyBackClicked, )
		}
	};
}
