...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJPFollowCommandLayer> : ModifyBase<ModifyDerive<Der, GJPFollowCommandLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x367ea0, Default, GJPFollowCommandLayer, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x368c30, Default, GJPFollowCommandLayer, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3684c0, Default, GJPFollowCommandLayer, textChanged, CCTextInputNode*)
		}
	};
}
