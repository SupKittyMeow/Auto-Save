...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, TutorialPopup> : ModifyBase<ModifyDerive<Der, TutorialPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5dce50, Default, TutorialPopup, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5dcf20, Default, TutorialPopup, show, )
		}
	};
}
