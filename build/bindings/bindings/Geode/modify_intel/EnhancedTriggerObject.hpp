...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, EnhancedTriggerObject> : ModifyBase<ModifyDerive<Der, EnhancedTriggerObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1b8570, Default, EnhancedTriggerObject, customObjectSetup, gd::vector<gd::string>&, gd::vector<void*>&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1b7a80, Default, EnhancedTriggerObject, getSaveString, GJBaseGameLayer*)
		}
	};
}
