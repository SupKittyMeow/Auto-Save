...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, OptionsScrollLayer> : ModifyBase<ModifyDerive<Der, OptionsScrollLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x61bc10, Default, OptionsScrollLayer, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x61bae0, Default, OptionsScrollLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x61bc50, Default, OptionsScrollLayer, cellPerformedAction, TableViewCell*, int, CellAction, cocos2d::CCNode*)
		}
	};
}
