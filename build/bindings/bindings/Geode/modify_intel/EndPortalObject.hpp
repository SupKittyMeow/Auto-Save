...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, EndPortalObject> : ModifyBase<ModifyDerive<Der, EndPortalObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x39f810, Default, EndPortalObject, getSpawnPos, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x39f780, Default, EndPortalObject, triggerObject, GJBaseGameLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x39fa00, Default, EndPortalObject, updateEndPos, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x39f390, Default, EndPortalObject, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x39f890, Default, EndPortalObject, setPosition, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x39f9a0, Default, EndPortalObject, setVisible, bool)
		}
	};
}
