...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, StartPosObject> : ModifyBase<ModifyDerive<Der, StartPosObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x175b94, Default, StartPosObject, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x175cd0, Default, StartPosObject, customObjectSetup, gd::vector<gd::string>&, gd::vector<void*>&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x175cd4, Default, StartPosObject, getSaveString, GJBaseGameLayer*)
		}
	};
}
