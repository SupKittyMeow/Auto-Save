...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCSprite> : ModifyBase<ModifyDerive<Der, cocos2d::CCSprite>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2843b0, Default, cocos2d::CCSprite, create, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2846b0, Default, cocos2d::CCSprite, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x284590, Default, cocos2d::CCSprite, createWithSpriteFrame, cocos2d::CCSpriteFrame*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x284680, Default, cocos2d::CCSprite, createWithSpriteFrameName, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x284130, Default, cocos2d::CCSprite, createWithTexture, cocos2d::CCTexture2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2842c0, Default, cocos2d::CCSprite, createWithTexture, cocos2d::CCTexture2D*, cocos2d::CCRect const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x286360, Default, cocos2d::CCSprite, setFlipX, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2863b0, Default, cocos2d::CCSprite, setFlipY, bool)
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(base::get() + 0x284b40, Default, cocos2d::CCSprite, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(base::get() + 0x284c40, Default, cocos2d::CCSprite)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2863a0, Default, cocos2d::CCSprite, isFlipX, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2863f0, Default, cocos2d::CCSprite, isFlipY, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x284790, Default, cocos2d::CCSprite, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x286200, Default, cocos2d::CCSprite, setVertexZ, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2860a0, Default, cocos2d::CCSprite, setScaleX, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x286110, Default, cocos2d::CCSprite, setScaleY, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x286180, Default, cocos2d::CCSprite, setScale, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x285df0, Default, cocos2d::CCSprite, setPosition, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x285fc0, Default, cocos2d::CCSprite, setSkewX, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x286030, Default, cocos2d::CCSprite, setSkewY, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x286270, Default, cocos2d::CCSprite, setAnchorPoint, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2862f0, Default, cocos2d::CCSprite, setVisible, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x285e70, Default, cocos2d::CCSprite, setRotation, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x285ee0, Default, cocos2d::CCSprite, setRotationX, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x285f50, Default, cocos2d::CCSprite, setRotationY, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2862e0, Default, cocos2d::CCSprite, ignoreAnchorPointForPosition, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x285930, Default, cocos2d::CCSprite, addChild, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x285940, Default, cocos2d::CCSprite, addChild, cocos2d::CCNode*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x285950, Default, cocos2d::CCSprite, addChild, cocos2d::CCNode*, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x285a90, Default, cocos2d::CCSprite, removeChild, cocos2d::CCNode*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x285ad0, Default, cocos2d::CCSprite, removeAllChildrenWithCleanup, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x285a10, Default, cocos2d::CCSprite, reorderChild, cocos2d::CCNode*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x285b90, Default, cocos2d::CCSprite, sortAllChildren, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x285810, Default, cocos2d::CCSprite, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x285350, Default, cocos2d::CCSprite, updateTransform, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x284950, Default, cocos2d::CCSprite, initWithTexture, cocos2d::CCTexture2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x284930, Default, cocos2d::CCSprite, initWithTexture, cocos2d::CCTexture2D*, cocos2d::CCRect const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2847b0, Default, cocos2d::CCSprite, initWithTexture, cocos2d::CCTexture2D*, cocos2d::CCRect const&, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x284ab0, Default, cocos2d::CCSprite, initWithSpriteFrame, cocos2d::CCSpriteFrame*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x284b00, Default, cocos2d::CCSprite, initWithSpriteFrameName, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2849c0, Default, cocos2d::CCSprite, initWithFile, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x284a50, Default, cocos2d::CCSprite, initWithFile, char const*, cocos2d::CCRect const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x286900, Default, cocos2d::CCSprite, setChildColor, cocos2d::_ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2866d0, Default, cocos2d::CCSprite, setChildOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2870f0, Default, cocos2d::CCSprite, getBatchNode, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x287100, Default, cocos2d::CCSprite, setBatchNode, cocos2d::CCSpriteBatchNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x284d00, Default, cocos2d::CCSprite, refreshTextureRect, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x284d90, Default, cocos2d::CCSprite, setTextureRect, cocos2d::CCRect const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x284db0, Default, cocos2d::CCSprite, setTextureRect, cocos2d::CCRect const&, bool, cocos2d::CCSize const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2850f0, Default, cocos2d::CCSprite, setVertexRect, cocos2d::CCRect const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x286de0, Default, cocos2d::CCSprite, setDisplayFrame, cocos2d::CCSpriteFrame*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x286eb0, Default, cocos2d::CCSprite, isFrameDisplayed, cocos2d::CCSpriteFrame*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x286f40, Default, cocos2d::CCSprite, displayFrame, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x286e60, Default, cocos2d::CCSprite, setDisplayFrameWithAnimationName, char const*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x285110, Default, cocos2d::CCSprite, setTextureCoords, cocos2d::CCRect const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x287170, Default, cocos2d::CCSprite, updateBlendFunc, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x285d10, Default, cocos2d::CCSprite, setReorderChildDirtyRecursively, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x285d70, Default, cocos2d::CCSprite, setDirtyRecursively, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x286520, Default, cocos2d::CCSprite, setOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x286c80, Default, cocos2d::CCSprite, updateDisplayedOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x286780, Default, cocos2d::CCSprite, setColor, cocos2d::_ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x286b20, Default, cocos2d::CCSprite, updateDisplayedColor, cocos2d::_ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2869b0, Default, cocos2d::CCSprite, setOpacityModifyRGB, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x286b00, Default, cocos2d::CCSprite, isOpacityModifyRGB, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2871d0, Default, cocos2d::CCSprite, setTexture, cocos2d::CCTexture2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x287340, Default, cocos2d::CCSprite, getTexture, )
		}
	};
}
