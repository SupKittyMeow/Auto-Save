...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupRandTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupRandTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5187fc, Default, SetupRandTriggerPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x518d24, Default, SetupRandTriggerPopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x518a84, Default, SetupRandTriggerPopup, textChanged, CCTextInputNode*)
		}
	};
}
