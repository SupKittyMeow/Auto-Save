...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, HardStreak> : ModifyBase<ModifyDerive<Der, HardStreak>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x8d3d4, Default, HardStreak, addPoint, cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x8d3b0, Default, HardStreak, reset, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x8d368, Default, HardStreak, resumeStroke, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x8d374, Default, HardStreak, stopStroke, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x8cac0, Default, HardStreak, init, )
		}
	};
}
