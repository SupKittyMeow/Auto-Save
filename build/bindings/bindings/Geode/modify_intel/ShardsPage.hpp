...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ShardsPage> : ModifyBase<ModifyDerive<Der, ShardsPage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4cf860, Default, ShardsPage, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4d1890, Default, ShardsPage, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4d1820, Default, ShardsPage, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4d1690, Default, ShardsPage, show, )
		}
	};
}
