...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, AchievementCell> : ModifyBase<ModifyDerive<Der, AchievementCell>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x24a370, Default, AchievementCell, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x24a3e0, Default, AchievementCell, draw, )
		}
	};
}
