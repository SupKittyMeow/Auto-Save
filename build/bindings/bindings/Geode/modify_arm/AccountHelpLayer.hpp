...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, AccountHelpLayer> : ModifyBase<ModifyDerive<Der, AccountHelpLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xb9358, Default, AccountHelpLayer, customSetup, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xba0e4, Default, AccountHelpLayer, layerHidden, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xb9f98, Default, AccountHelpLayer, accountStatusChanged, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xb9fa4, Default, AccountHelpLayer, FLAlert_Clicked, FLAlertLayer*, bool)
		}
	};
}
