...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCGLProgram> : ModifyBase<ModifyDerive<Der, cocos2d::CCGLProgram>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x435940, Default, cocos2d::CCGLProgram, setUniformsForBuiltins, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x434970, Default, cocos2d::CCGLProgram, use, )
		}
	};
}
