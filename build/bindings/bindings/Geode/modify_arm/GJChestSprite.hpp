...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJChestSprite> : ModifyBase<ModifyDerive<Der, GJChestSprite>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1ca94c, Default, GJChestSprite, setOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1ca878, Default, GJChestSprite, setColor, cocos2d::ccColor3B const&)
		}
	};
}
