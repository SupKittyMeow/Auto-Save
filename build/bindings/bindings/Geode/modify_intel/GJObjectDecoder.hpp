...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJObjectDecoder> : ModifyBase<ModifyDerive<Der, GJObjectDecoder>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x731e10, Default, GJObjectDecoder, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x731e20, Default, GJObjectDecoder, getDecodedObject, int, DS_Dictionary*)
		}
	};
}
