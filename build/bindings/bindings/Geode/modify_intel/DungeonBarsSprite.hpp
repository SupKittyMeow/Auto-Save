...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, DungeonBarsSprite> : ModifyBase<ModifyDerive<Der, DungeonBarsSprite>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4b2440, Default, DungeonBarsSprite, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4b24c0, Default, DungeonBarsSprite, visit, )
		}
	};
}
