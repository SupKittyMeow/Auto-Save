...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupObjectOptionsPopup> : ModifyBase<ModifyDerive<Der, SetupObjectOptionsPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x319b30, Default, SetupObjectOptionsPopup, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x319b70, Default, SetupObjectOptionsPopup, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x319720, Default, SetupObjectOptionsPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x319bd0, Default, SetupObjectOptionsPopup, onClose, cocos2d::CCObject*)
		}
	};
}
