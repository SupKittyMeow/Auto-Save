...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GravityEffectSprite> : ModifyBase<ModifyDerive<Der, GravityEffectSprite>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xab340, Default, GravityEffectSprite, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xab564, Default, GravityEffectSprite, draw, )
		}
	};
}
