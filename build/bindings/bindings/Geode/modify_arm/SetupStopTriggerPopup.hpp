...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupStopTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupStopTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4d7a84, Default, SetupStopTriggerPopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4d7a0c, Default, SetupStopTriggerPopup, onCustomToggleTriggerValue, cocos2d::CCObject*)
		}
	};
}
