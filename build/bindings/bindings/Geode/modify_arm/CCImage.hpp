...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCImage> : ModifyBase<ModifyDerive<Der, cocos2d::CCImage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3f7f58, Default, cocos2d::CCImage, initWithImageData, void*, int, cocos2d::CCImage::EImageFormat, int, int, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3f7d24, Default, cocos2d::CCImage, initWithImageFile, char const*, cocos2d::CCImage::EImageFormat)
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(base::get() + 0x3f7c40, Default, cocos2d::CCImage, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(base::get() + 0x3f7ca8, Default, cocos2d::CCImage)
		}
	};
}
