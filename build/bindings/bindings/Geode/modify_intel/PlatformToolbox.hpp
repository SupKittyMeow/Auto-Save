...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, PlatformToolbox> : ModifyBase<ModifyDerive<Der, PlatformToolbox>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4cdbb0, Default, PlatformToolbox, hideCursor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4cea70, Default, PlatformToolbox, isControllerConnected, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4cdbd0, Default, PlatformToolbox, showCursor, )
		}
	};
}
