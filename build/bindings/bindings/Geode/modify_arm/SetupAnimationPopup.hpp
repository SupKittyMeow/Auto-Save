...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupAnimationPopup> : ModifyBase<ModifyDerive<Der, SetupAnimationPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x35a324, Default, SetupAnimationPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x35a6bc, Default, SetupAnimationPopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x35a50c, Default, SetupAnimationPopup, textChanged, CCTextInputNode*)
		}
	};
}
