...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ChallengeNode> : ModifyBase<ModifyDerive<Der, ChallengeNode>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x328294, Default, ChallengeNode, create, GJChallengeItem*, ChallengesPage*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x328808, Default, ChallengeNode, init, GJChallengeItem*, ChallengesPage*, bool)
		}
	};
}
