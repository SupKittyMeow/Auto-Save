...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJSpiderSprite> : ModifyBase<ModifyDerive<Der, GJSpiderSprite>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x50fc60, Default, GJSpiderSprite, create, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x50fd94, Default, GJSpiderSprite, init, int)
		}
	};
}
