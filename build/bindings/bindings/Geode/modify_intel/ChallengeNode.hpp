...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ChallengeNode> : ModifyBase<ModifyDerive<Der, ChallengeNode>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3a1490, Default, ChallengeNode, create, GJChallengeItem*, ChallengesPage*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3a1a50, Default, ChallengeNode, init, GJChallengeItem*, ChallengesPage*, bool)
		}
	};
}
