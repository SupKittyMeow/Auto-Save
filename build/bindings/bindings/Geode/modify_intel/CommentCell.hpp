...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CommentCell> : ModifyBase<ModifyDerive<Der, CommentCell>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x242fa0, Default, CommentCell, loadFromComment, GJComment*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x250990, Default, CommentCell, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x250cb0, Default, CommentCell, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x250d80, Default, CommentCell, likedItem, LikeItemType, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x251120, Default, CommentCell, FLAlert_Clicked, FLAlertLayer*, bool)
		}
	};
}
