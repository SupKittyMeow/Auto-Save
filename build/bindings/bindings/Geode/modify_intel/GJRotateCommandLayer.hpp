...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJRotateCommandLayer> : ModifyBase<ModifyDerive<Der, GJRotateCommandLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x43f0, Default, GJRotateCommandLayer, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5340, Default, GJRotateCommandLayer, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4da0, Default, GJRotateCommandLayer, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4910, Default, GJRotateCommandLayer, valuePopupClosed, ConfigureValuePopup*, float)
		}
	};
}
