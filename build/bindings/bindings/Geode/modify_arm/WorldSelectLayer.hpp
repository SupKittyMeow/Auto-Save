...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, WorldSelectLayer> : ModifyBase<ModifyDerive<Der, WorldSelectLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x34a418, Default, WorldSelectLayer, onExit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x34a338, Default, WorldSelectLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x34a1f0, Default, WorldSelectLayer, scrollLayerWillScrollToPage, BoomScrollLayer*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x34a0a8, Default, WorldSelectLayer, scrollLayerScrolledToPage, BoomScrollLayer*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x34a468, Default, WorldSelectLayer, scrollLayerMoved, cocos2d::CCPoint)
		}
	};
}
