...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CustomSFXWidget> : ModifyBase<ModifyDerive<Der, CustomSFXWidget>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5ee330, Default, CustomSFXWidget, downloadSFXFinished, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5ee3d0, Default, CustomSFXWidget, downloadSFXFailed, int, GJSongError)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5ee2c0, Default, CustomSFXWidget, songStateChanged, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5ee5b0, Default, CustomSFXWidget, FLAlert_Clicked, FLAlertLayer*, bool)
		}
	};
}
