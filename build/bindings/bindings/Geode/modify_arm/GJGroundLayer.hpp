...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJGroundLayer> : ModifyBase<ModifyDerive<Der, GJGroundLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x51c3b4, Default, GJGroundLayer, init, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x51d1b8, Default, GJGroundLayer, showGround, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x51d1c4, Default, GJGroundLayer, fadeInGround, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x51d398, Default, GJGroundLayer, fadeOutGround, float)
		}
	};
}
