...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GManager> : ModifyBase<ModifyDerive<Der, GManager>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4181c4, Default, GManager, save, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4182bc, Default, GManager, saveGMTo, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x417f4c, Default, GManager, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x417f5c, Default, GManager, setup, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4184f4, Default, GManager, encodeDataTo, DS_Dictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x418b10, Default, GManager, dataLoaded, DS_Dictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x418b14, Default, GManager, firstLoad, )
		}
	};
}
