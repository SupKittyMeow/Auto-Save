...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTouch> : ModifyBase<ModifyDerive<Der, cocos2d::CCTouch>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x50be8, Default, cocos2d::CCTouch, getLocation, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x50c14, Default, cocos2d::CCTouch, getPreviousLocation, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x50c40, Default, cocos2d::CCTouch, getStartLocation, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x50c6c, Default, cocos2d::CCTouch, getDelta, )
		}
	};
}
