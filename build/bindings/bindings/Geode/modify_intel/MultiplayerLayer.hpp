...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, MultiplayerLayer> : ModifyBase<ModifyDerive<Der, MultiplayerLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x39de70, Default, MultiplayerLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x39df60, Default, MultiplayerLayer, keyBackClicked, )
		}
	};
}
