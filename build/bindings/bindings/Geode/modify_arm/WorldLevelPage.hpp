...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, WorldLevelPage> : ModifyBase<ModifyDerive<Der, WorldLevelPage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x34d2a0, Default, WorldLevelPage, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x34d158, Default, WorldLevelPage, show, )
		}
	};
}
