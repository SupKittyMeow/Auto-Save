...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJGameLoadingLayer> : ModifyBase<ModifyDerive<Der, GJGameLoadingLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x15a350, Default, GJGameLoadingLayer, onEnter, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x15a340, Default, GJGameLoadingLayer, onEnterTransitionDidFinish, )
		}
	};
}
