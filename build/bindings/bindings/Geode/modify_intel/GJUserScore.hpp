...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJUserScore> : ModifyBase<ModifyDerive<Der, GJUserScore>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x567170, Default, GJUserScore, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5672d0, Default, GJUserScore, init, )
		}
	};
}
