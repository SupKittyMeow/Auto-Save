...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCSpriteFrameCache> : ModifyBase<ModifyDerive<Der, cocos2d::CCSpriteFrameCache>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x31a9f0, Default, cocos2d::CCSpriteFrameCache, sharedSpriteFrameCache, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x31acd0, Default, cocos2d::CCSpriteFrameCache, addSpriteFramesWithDictionary, cocos2d::CCDictionary*, cocos2d::CCTexture2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x31b8b0, Default, cocos2d::CCSpriteFrameCache, addSpriteFramesWithFile, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x31c720, Default, cocos2d::CCSpriteFrameCache, spriteFrameByName, char const*)
		}
	};
}
