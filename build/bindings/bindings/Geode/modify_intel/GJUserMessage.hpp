...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJUserMessage> : ModifyBase<ModifyDerive<Der, GJUserMessage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x567830, Default, GJUserMessage, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5678d0, Default, GJUserMessage, init, )
		}
	};
}
