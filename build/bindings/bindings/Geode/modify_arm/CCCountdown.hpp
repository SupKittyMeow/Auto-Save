...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCCountdown> : ModifyBase<ModifyDerive<Der, CCCountdown>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6d7a88, Default, CCCountdown, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6d7e38, Default, CCCountdown, setOpacity, unsigned char)
		}
	};
}
