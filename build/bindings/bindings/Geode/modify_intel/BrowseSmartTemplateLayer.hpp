...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, BrowseSmartTemplateLayer> : ModifyBase<ModifyDerive<Der, BrowseSmartTemplateLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f5220, Default, BrowseSmartTemplateLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4f5260, Default, BrowseSmartTemplateLayer, onBack, cocos2d::CCObject*)
		}
	};
}
