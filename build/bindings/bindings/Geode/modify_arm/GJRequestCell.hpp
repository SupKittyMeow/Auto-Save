...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJRequestCell> : ModifyBase<ModifyDerive<Der, GJRequestCell>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fc704, Default, GJRequestCell, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fc9e0, Default, GJRequestCell, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fca8c, Default, GJRequestCell, FLAlert_Clicked, FLAlertLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fcc18, Default, GJRequestCell, uploadActionFinished, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fce18, Default, GJRequestCell, uploadActionFailed, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fcef0, Default, GJRequestCell, onClosePopup, UploadActionPopup*)
		}
	};
}
