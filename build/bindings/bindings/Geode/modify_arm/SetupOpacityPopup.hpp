...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupOpacityPopup> : ModifyBase<ModifyDerive<Der, SetupOpacityPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4fba4, Default, SetupOpacityPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x500a8, Default, SetupOpacityPopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4fe60, Default, SetupOpacityPopup, textInputClosed, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4fe7c, Default, SetupOpacityPopup, textChanged, CCTextInputNode*)
		}
	};
}
