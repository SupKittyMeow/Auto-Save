...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCMotionStreak> : ModifyBase<ModifyDerive<Der, cocos2d::CCMotionStreak>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4c9b74, Default, cocos2d::CCMotionStreak, create, float, float, float, cocos2d::_ccColor3B const&, cocos2d::CCTexture2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4c99e4, Default, cocos2d::CCMotionStreak, create, float, float, float, cocos2d::_ccColor3B const&, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4c9c7c, Default, cocos2d::CCMotionStreak, initWithFade, float, float, float, cocos2d::_ccColor3B const&, cocos2d::CCTexture2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4c9afc, Default, cocos2d::CCMotionStreak, initWithFade, float, float, float, cocos2d::_ccColor3B const&, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4ca540, Default, cocos2d::CCMotionStreak, reset, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4ca00c, Default, cocos2d::CCMotionStreak, resumeStroke, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(base::get() + 0x4c9930, Default, cocos2d::CCMotionStreak)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4ca018, Default, cocos2d::CCMotionStreak, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4c9e20, Default, cocos2d::CCMotionStreak, setPosition, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4ca54c, Default, cocos2d::CCMotionStreak, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4c9f80, Default, cocos2d::CCMotionStreak, getOpacity, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4c9f78, Default, cocos2d::CCMotionStreak, setOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4c9f90, Default, cocos2d::CCMotionStreak, setOpacityModifyRGB, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4c9f98, Default, cocos2d::CCMotionStreak, isOpacityModifyRGB, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4c9f58, Default, cocos2d::CCMotionStreak, setBlendFunc, cocos2d::_ccBlendFunc)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4c9f68, Default, cocos2d::CCMotionStreak, getBlendFunc, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4c9eb8, Default, cocos2d::CCMotionStreak, getTexture, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4c9ec8, Default, cocos2d::CCMotionStreak, setTexture, cocos2d::CCTexture2D*)
		}
	};
}
