...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CommunityCreditsPage> : ModifyBase<ModifyDerive<Der, CommunityCreditsPage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2ae0a8, Default, CommunityCreditsPage, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2b03c8, Default, CommunityCreditsPage, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2b034c, Default, CommunityCreditsPage, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2b01c4, Default, CommunityCreditsPage, show, )
		}
	};
}
