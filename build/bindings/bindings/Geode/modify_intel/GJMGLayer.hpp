...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJMGLayer> : ModifyBase<ModifyDerive<Der, GJMGLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5f5fd0, Default, GJMGLayer, updateMG01Blend, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5f6020, Default, GJMGLayer, updateMG02Blend, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5f5f90, Default, GJMGLayer, showGround, )
		}
	};
}
