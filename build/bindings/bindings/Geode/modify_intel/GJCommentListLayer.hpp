...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJCommentListLayer> : ModifyBase<ModifyDerive<Der, GJCommentListLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x29a930, Default, GJCommentListLayer, create, BoomListView*, char const*, cocos2d::ccColor4B, float, float, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x29aa40, Default, GJCommentListLayer, init, BoomListView*, char const*, cocos2d::ccColor4B, float, float, bool)
		}
	};
}
