...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, AudioEffectsLayer> : ModifyBase<ModifyDerive<Der, AudioEffectsLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x41ab8c, Default, AudioEffectsLayer, resetAudioVars, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x41ae04, Default, AudioEffectsLayer, updateTweenAction, float, char const*)
		}
	};
}
