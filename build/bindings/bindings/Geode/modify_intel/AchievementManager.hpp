...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, AchievementManager> : ModifyBase<ModifyDerive<Der, AchievementManager>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x790ad0, Default, AchievementManager, isAchievementEarned, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x790af0, Default, AchievementManager, percentForAchievement, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x739060, Default, AchievementManager, init, )
		}
	};
}
