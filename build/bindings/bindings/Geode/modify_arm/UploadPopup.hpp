...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, UploadPopup> : ModifyBase<ModifyDerive<Der, UploadPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22390c, Default, UploadPopup, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2234dc, Default, UploadPopup, levelUploadFinished, GJGameLevel*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x223714, Default, UploadPopup, levelUploadFailed, GJGameLevel*)
		}
	};
}
