...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, AchievementCell> : ModifyBase<ModifyDerive<Der, AchievementCell>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f47b0, Default, AchievementCell, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f481c, Default, AchievementCell, draw, )
		}
	};
}
